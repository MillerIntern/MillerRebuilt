...
$(document).ready(function () {
  $('.autofill_NA').click(function () {
    if (
      !confirm(
        'Are you sure you want to mark all of the Permits and Inspections for this project as N/A?'
      )
    )
      return;
...
$(document).ready(function () {
  ...
  $('#closeoutData')
    ...
    .click(function () {
      if (
        $(this).attr('id') !== 'save-closeout' &&
        $(this).attr('id') !== 'backToFailedRulesCloseOut'
      ) {
  ...
  $('#closeoutData')
    ...
    .change(function () {
      ...
      $('#closeoutData')
        .find('#' + $(this).attr('data-associated-date'))
        .val(getToday());
    });
});
...
function generateViewTableHeaders() {
  ...
  if ($('#dashboardViewValue').val() == 0) {
    ...
    $('#projectTableDiv')
      .find('table tbody')
      .prepend('<tr class="head" id = "ViewHeaderRow"></tr>');
    var projectTableRow = $('#projectTableDiv').find(
      $('#results tbody').find('#ViewHeaderRow')
    );
...
function convertSalvage(value) {
  if (value === -2 || value === undefined) return 'TBD';
  else if (value === -1) return 'N/A';
...
function fillTabs_CLOSEOUT(data) {
  ...
  if (json.closeoutDetails != null) {
    ...
    $('#closeoutData')
      .find('#costcoSignoff')
      .val(json.closeoutDetails.costcoSignoff);
    $('#closeoutData').find('#punchList').val(json.closeoutDetails.punchList);
    $('#closeoutData')
      .find('#alarmHvac')
      .val(json.closeoutDetails.alarmHvacForm);
    $('#closeoutData')
      .find('#verisae')
      .val(json.closeoutDetails.verisaeShutdownReport);
    $('#closeoutData')
      .find('#closeoutBook')
      .val(json.closeoutDetails.closeoutBook);

    formatRelativeTextAreas(
      json.closeoutDetails.closeoutNotes,
      'closeoutNotes',
      'closeoutData'
    );
    ...
    $('#closeoutData')
      .find('#closeoutNotes')
      .val(json.closeoutDetails.closeoutNotes);
    $('#closeoutData')
      .find('#buildingPermitCL')
      .val(json.closeoutDetails.buildingPermitCL);
    $('#closeoutData')
      .find('#closeoutPhotosCL')
      .val(json.closeoutDetails.closeoutPhotosCL);
    $('#closeoutData')
      .find('#MCSWarranty')
      .val(json.closeoutDetails.mCSWarranty);
    $('#closeoutData')
      .find('#equipmentSubCL')
      .val(json.closeoutDetails.equipmentSubCL);
    $('#closeoutData').find('#traneCL').val(json.closeoutDetails.traneCL);
    $('#closeoutData')
      .find('#numOfChangeOrders')
      .val(json.closeoutDetails.numOfChangeOrders);
    $('#closeoutData')
      .find('#numOfChangeOrdersCompleted')
      .val(json.closeoutDetails.numOfChangeOrdersCompleted);
    $('#closeoutData')
      .find('#numOfMCSChangeOrders')
      .val(json.changeOrders.length);
    ...
    for (var i = 0; i < cos.length; i++) {
      ...
      if (changeOrder.status === '5') completed = completed + 1;
      else if (changeOrder.status === '4') completed = completed + 1;
    }
    ...
    $('#closeoutData')
      .find('#equipmentSubmittalStatus')
      .val(convertDefault(json.closeoutDetails.equipmentSubmittalStatus));

    $('#closeoutData')
      .find('#manualStatus')
      .val(convertDefault(json.closeoutDetails.manualStatus));
    $('#closeoutData').find('#manualDate').val(json.closeoutDetails.manualDate);

    $('#closeoutData')
      .find('#costcoSignoffStatus')
      .val(convertDefault(json.closeoutDetails.costcoSignoffStatus));
    $('#closeoutData')
      .find('#punchListStatus')
      .val(convertDefault(json.closeoutDetails.punchListStatus));

    $('#closeoutData')
      .find('#hvacCloseoutStatus')
      .val(convertDefault(json.closeoutDetails.hvacCloseoutStatus));
    $('#closeoutData')
      .find('#refrigerationCloseoutStatus')
      .val(convertDefault(json.closeoutDetails.refrigerationCloseoutStatus));

    $('#closeoutData')
      .find('#asBuiltDrawingsStatus')
      .val(convertDefault(json.closeoutDetails.asBuiltDrawingsStatus));

    $('#closeoutData')
      .find('#closeOutPhotosStatus')
      .val(convertDefault(json.closeoutDetails.closeOutPhotosStatus));

    $('#closeoutData')
      .find('#HVACstartupFormStatus')
      .val(convertDefault(json.closeoutDetails.HVACstartupFormStatus));
    $('#closeoutData')
      .find('#HVACstartupFormDate')
      .val(json.closeoutDetails.HVACstartupFormDate);

    $('#closeoutData')
      .find('#pbnMTStatus')
      .val(convertDefault(json.closeoutDetails.pbnMTStatus));
    $('#closeoutData').find('#pbnMTDate').val(json.closeoutDetails.pbnMTDate);

    $('#closeoutData')
      .find('#salvageStatus')
      .val(convertDefault(json.closeoutDetails.salvageStatus));

    $('#closeoutData')
      .find('#alarmFormStatus')
      .val(convertDefault(json.closeoutDetails.alarmFormStatus));

    $('#closeoutData')
      .find('#verisaeReportStatus')
      .val(convertDefault(json.closeoutDetails.verisaeReportStatus));

    $('#closeoutData')
      .find('#MCSWarrantyStatus')
      .val(convertDefault(json.closeoutDetails.MCSWarrantyStatus));

    $('#closeoutData')
      .find('#GCWarrantyStatus')
      .val(convertDefault(json.closeoutDetails.GCWarrantyStatus));
    $('#closeoutData')
      .find('#GCWarrantyDate')
      .val(json.closeoutDetails.GCWarrantyDate);

    $('#closeoutData')
      .find('#mechanicalWarrantyStatus')
      .val(convertDefault(json.closeoutDetails.mechanicalWarrantyStatus));
    $('#closeoutData')
      .find('#mechanicalWarrantyDate')
      .val(json.closeoutDetails.mechanicalWarrantyDate);

    $('#closeoutData')
      .find('#electricalWarrantyStatus')
      .val(convertDefault(json.closeoutDetails.electricalWarrantyStatus));
    $('#closeoutData')
      .find('#electricalWarrantyDate')
      .val(json.closeoutDetails.electricalWarrantyDate);

    $('#closeoutData')
      .find('#plumbingWarrantyStatus')
      .val(convertDefault(json.closeoutDetails.plumbingWarrantyStatus));
    $('#closeoutData')
      .find('#plumbingWarrantyDate')
      .val(json.closeoutDetails.plumbingWarrantyDate);

    $('#closeoutData')
      .find('#gasWarrantyStatus')
      .val(convertDefault(json.closeoutDetails.gasWarrantyStatus));
    $('#closeoutData')
      .find('#gasWarrantyDate')
      .val(json.closeoutDetails.gasWarrantyDate);

    $('#closeoutData')
      .find('#sprinkleWarrantyStatus')
      .val(convertDefault(json.closeoutDetails.sprinkleWarrantyStatus));
    $('#closeoutData')
      .find('#sprinkleWarrantyDate')
      .val(json.closeoutDetails.sprinkleWarrantyDate);

    $('#closeoutData')
      .find('#HTIWarrantyStatus')
      .val(convertDefault(json.closeoutDetails.HTIWarrantyStatus));
    $('#closeoutData')
      .find('#HTIWarrantyDate')
      .val(json.closeoutDetails.HTIWarrantyDate);

    $('#closeoutData')
      .find('#otherWarrantyStatusA')
      .val(convertDefault(json.closeoutDetails.otherWarrantyStatusA));
    $('#closeoutData')
      .find('#otherWarrantyDateA')
      .val(json.closeoutDetails.otherWarrantyDateA);

    $('#closeoutData')
      .find('#otherWarrantyStatusB')
      .val(convertDefault(json.closeoutDetails.otherWarrantyStatusB));
    $('#closeoutData')
      .find('#otherWarrantyDateB')
      .val(json.closeoutDetails.otherWarrantyDateB);

    $('#closeoutData')
      .find('#MCSStatus')
      .val(convertDefault(json.closeoutDetails.MCSStatus));
    $('#closeoutData').find('#MCSDate').val(json.closeoutDetails.MCSDate);

    $('#closeoutData')
      .find('#GCStatus')
      .val(convertDefault(json.closeoutDetails.GCStatus));
    $('#closeoutData').find('#GCDate').val(json.closeoutDetails.GCDate);

    $('#closeoutData')
      .find('#mechanicalStatus')
      .val(convertDefault(json.closeoutDetails.mechanicalStatus));
    $('#closeoutData')
      .find('#mechanicalDate')
      .val(json.closeoutDetails.mechanicalDate);

    $('#closeoutData')
      .find('#electricalStatus')
      .val(convertDefault(json.closeoutDetails.electricalStatus));
    $('#closeoutData')
      .find('#electricalDate')
      .val(json.closeoutDetails.electricalDate);

    $('#closeoutData')
      .find('#plumbingStatus')
      .val(convertDefault(json.closeoutDetails.plumbingStatus));
    $('#closeoutData')
      .find('#plumbingDate')
      .val(json.closeoutDetails.plumbingDate);

    $('#closeoutData')
      .find('#gasStatus')
      .val(convertDefault(json.closeoutDetails.gasStatus));
    $('#closeoutData').find('#gasDate').val(json.closeoutDetails.gasDate);

    $('#closeoutData')
      .find('#sprinkleStatus')
      .val(convertDefault(json.closeoutDetails.sprinkleStatus));
    $('#closeoutData')
      .find('#sprinkleDate')
      .val(json.closeoutDetails.sprinkleDate);

    $('#closeoutData')
      .find('#HTIStatus')
      .val(convertDefault(json.closeoutDetails.HTIStatus));
    $('#closeoutData').find('#HTIDate').val(json.closeoutDetails.HTIDate);

    $('#closeoutData')
      .find('#otherFinalLiensStatus')
      .val(convertDefault(json.closeoutDetails.otherFinalLeinsStatus));
    $('#closeoutData')
      .find('#otherFinalLiensDate')
      .val(json.closeoutDetails.otherFinalLeinsDate);

    $('#closeoutData')
      .find('#otherFinalLiensBStatus')
      .val(convertDefault(json.closeoutDetails.otherFinalLeinsBStatus));
    $('#closeoutData')
      .find('#otherFinalLiensBDate')
      .val(json.closeoutDetails.otherFinalLeinsBDate);

    $('#closeoutData')
      .find('#mg2CompletionDate')
      .val(json.closeoutDetails.mg2CompletionDate);
    $('#closeoutData')
      .find('#mg2CompletionStatus')
      .val(json.closeoutDetails.mg2CompletionStatus);

    formatRelativeTextAreas(
      json.closeoutDetails.finalLiensNotes,
      'finalLiensNotes',
      'closeoutData'
    );
    $('#closeoutData')
      .find('#finalLiensNotes')
      .val(json.closeoutDetails.finalLiensNotes);
    formatRelativeTextAreas(
      json.closeoutDetails.closeoutDocumentNotes,
      'closeoutDocumentNotes',
      'closeoutData'
    );
    $('#closeoutData')
      .find('#closeoutDocumentsNotes')
      .val(json.closeoutDetails.closeoutDocumentsNotes);
    formatRelativeTextAreas(
      json.closeoutDetails.warrantyNotes,
      'warrantyNotes',
      'closeoutData'
    );
    $('#closeoutData')
      .find('#warrantyNotes')
      .val(json.closeoutDetails.warrantyNotes);

    $('#closeoutData')
      .find('#substantialCompletionStatus')
      .val(convertDefault(json.closeoutDetails.substantialCompletionStatus));
    $('#closeoutData')
      .find('#substantialCompletionDate')
      .val(json.closeoutDetails.substantialCompletionDate);

    $('#closeoutData')
      .find('#paymentOfDebtsAndClaimsStatus')
      .val(convertDefault(json.closeoutDetails.paymentOfDebtsAndClaimsStatus));
    $('#closeoutData')
      .find('#paymentOfDebtsAndClaimsDate')
      .val(json.closeoutDetails.paymentOfDebtsAndClaimsDate);

    $('#closeoutData')
      .find('#releaseOfLiensStatus')
      .val(convertDefault(json.closeoutDetails.releaseOfLiensStatus));
    $('#closeoutData')
      .find('#releaseOfLiensDate')
      .val(json.closeoutDetails.releaseOfLiensDate);

    $('#closeoutData')
      .find('#mulvannySignOffStatus')
      .val(convertDefault(json.closeoutDetails.mulvannySignOffStatus));
    $('#closeoutData')
      .find('#mulvannySignOffDate')
      .val(json.closeoutDetails.mulvannySignOffDate);
...
function fillDropdowns_CLOSEOUT(data) {
  ...
  for (var i = 0; i < CLOSEOUTSTATUS_DROPDOWNS.length; i++) {
    ...
    $('#closeoutData')
      .find('#' + CLOSEOUTSTATUS_DROPDOWNS[i])
      .find('[value != "default"]')
      .remove();
    $('#closeoutData')
      .find('#' + CLOSEOUTSTATUS_DROPDOWNS[i])
...
function saveProject_CLOSEOUT() {
  ...
  var mg2CompletionStatus = $('#closeoutData')
    .find('#mg2CompletionStatus')
    .val();
  ...
  var numOfChangeOrdersCompleted = $('#closeoutData')
    .find('#numOfChangeOrdersCompleted')
    .val();

  var numOfMCSChangeOrders = $('#closeoutData')
    .find('#numOfMCSChangeOrders')
    .val();
  var numOfMCSChangeOrdersCompleted = $('#closeoutData')
    .find('#numOfMCSChangeOrdersCompleted')
    .val();
  ...
  var otherFinalLeinsStatus = $('#closeoutData')
    .find('#otherFinalLiensStatus')
    .val();
  var otherFinalLeinsDate = $('#closeoutData')
    .find('#otherFinalLiensDate')
    .val();

  var otherFinalLeinsBStatus = $('#closeoutData')
    .find('#otherFinalLiensBStatus')
    .val();
  var otherFinalLeinsBDate = $('#closeoutData')
    .find('#otherFinalLiensBDate')
    .val();
  ...
  var mechanicalWarrantyStatus = $('#closeoutData')
    .find('#mechanicalWarrantyStatus')
    .val();
  var mechanicalWarrantyDate = $('#closeoutData')
    .find('#mechanicalWarrantyDate')
    .val();

  var electricalWarrantyStatus = $('#closeoutData')
    .find('#electricalWarrantyStatus')
    .val();
  var electricalWarrantyDate = $('#closeoutData')
    .find('#electricalWarrantyDate')
    .val();

  var plumbingWarrantyStatus = $('#closeoutData')
    .find('#plumbingWarrantyStatus')
    .val();
  var plumbingWarrantyDate = $('#closeoutData')
    .find('#plumbingWarrantyDate')
    .val();
  ...
  var sprinkleWarrantyStatus = $('#closeoutData')
    .find('#sprinkleWarrantyStatus')
    .val();
  var sprinkleWarrantyDate = $('#closeoutData')
    .find('#sprinkleWarrantyDate')
    .val();
  ...
  var otherWarrantyStatusA = $('#closeoutData')
    .find('#otherWarrantyStatusA')
    .val();
  var otherWarrantyDateA = $('#closeoutData').find('#otherWarrantyDateA').val();

  var otherWarrantyStatusB = $('#closeoutData')
    .find('#otherWarrantyStatusB')
    .val();
  ...
  // CLOSEOUT DOCUMENTS
  var equipmentSubmittalStatus = $('#closeoutData')
    .find('#equipmentSubmittalStatus')
    .val();
  ...
  var refrigerationCloseoutStatus = $('#closeoutData')
    .find('#refrigerationCloseoutStatus')
    .val();

  var costcoSignoffStatus = $('#closeoutData')
    .find('#costcoSignoffStatus')
    .val();
  ...
  var asBuiltDrawingsStatus = $('#closeoutData')
    .find('#asBuiltDrawingsStatus')
    .val();
  // asBuilts = asBuiltDrawingsDate

  var closeOutPhotosStatus = $('#closeoutData')
    .find('#closeOutPhotosStatus')
    .val();
  //closeoutPhotosCL = closeOutPhotosDate

  var HVACstartupFormStatus = $('#closeoutData')
    .find('#HVACstartupFormStatus')
    .val();
  var HVACstartupFormDate = $('#closeoutData')
    .find('#HVACstartupFormDate')
    .val();
  ...
  var verisaeReportStatus = $('#closeoutData')
    .find('#verisaeReportStatus')
    .val();
  // verisae = verisaeReportDate

  var closeoutDocumentsNotes = $('#closeoutData')
    .find('#closeoutDocumentsNotes')
    .val();
  ...
  if (salvageAmount === 'N/A') salvageAmount = -1;
  else if (salvageAmount === 'TBD') salvageAmount = -2;

  console.log('SALVAGE AMOUNT ', salvageAmount);

  var substantialCompletionStatus = $('#closeoutData')
    .find('#substantialCompletionStatus')
    .val();
  var substantialCompletionDate = $('#closeoutData')
    .find('#substantialCompletionDate')
    .val();

  var paymentOfDebtsAndClaimsStatus = $('#closeoutData')
    .find('#paymentOfDebtsAndClaimsStatus')
    .val();
  var paymentOfDebtsAndClaimsDate = $('#closeoutData')
    .find('#paymentOfDebtsAndClaimsDate')
    .val();

  var releaseOfLiensStatus = $('#closeoutData')
    .find('#releaseOfLiensStatus')
    .val();
  var releaseOfLiensDate = $('#closeoutData').find('#releaseOfLiensDate').val();

  var mulvannySignOffStatus = $('#closeoutData')
    .find('#mulvannySignOffStatus')
    .val();
  var mulvannySignOffDate = $('#closeoutData')
    .find('#mulvannySignOffDate')
    .val();
  ////////////// END NEW CONTENT
  ...
  var dates_CLOSEOUT = [
    ...
    GCWarrantyDate,
    mechanicalWarrantyDate,
    electricalWarrantyDate,
    sprinkleWarrantyDate,
...
var CLOSEOUTSTATUS_DROPDOWNS = [
  ...
  'copApprovedStatus',
  'copCompletedStatus',
  'changeOrderSubmittedStatus',
  'changeOrderApprovedStatus',
  'revisionsSubmittedStatus',
  'revisionsApprovedStatus',
  ...
  'sprinkleStatus',
  'HTIStatus',
  'otherFinalLiensStatus',
  'otherFinalLiensBStatus',
  ...
  'electricalWarrantyStatus',
  'sprinkleWarrantyStatus',
  'plumbingWarrantyStatus',
  'gasWarrantyStatus',
  'HTIWarrantyStatus',
  'otherWarrantyStatusA',
  'otherWarrantyStatusB',

  'equipmentSubmittalStatus',
  'manualStatus',
  'costcoSignoffStatus',
  'punchListStatus',
  'asBuiltDrawingsStatus',
  'closeOutPhotosStatus',
  'HVACstartupFormStatus',
  'pbnMTStatus',
  'salvageStatus',
  'alarmFormStatus',
  'verisaeReportStatus',
  'substantialCompletionStatus',
  'paymentOfDebtsAndClaimsStatus',
  'releaseOfLiensStatus',
...
$(document).ready(function () {
  $('#permitData')
    ...
    .click(function () {
      if (
        $(this).attr('id') !== 'save-permits' &&
        $(this).attr('id') !== 'backToFailedRulesPermits'
      ) {
  ...
  if (
    !(
      ...
      $('#generalInformation').find('#autofill-Permits').val() == undefined
    )
  )
  ...
  if (projectID !== null) {
    $.ajax({
      ...
      success: function (data) {
        ...
        } else fillPermitsAndInspectionsWithNA(PROJECT_DATA);
      },
    });
  } else {
    alert("That's weird... You might want to go back and try again");
...
function getProjectEnums_PERMIT() {
  $.ajax({
    ...
    success: function (data) {
      ...
      if (EDIT_INTENTION == true) getProject_PERMIT();
    },
  });
}
...
function fillTabs_PERMIT(data) {
  ...
  $('#permitData')
    .find('.projectIdentifier')
    .html(
      json.warehouse.city.name +
        ', ' +
        json.warehouse.state +
        ' --- ' +
        json.projectItem.name
    );

  console.log(json);
  if (json.permits != null) {
    $('#permitData')
      .find('#buildingPermitLastUpdated')
      .val(json.permits.building);
    $('#permitData')
      .find('#buildingPermitStatus')
      .val(convertUndefined(json.permits.buildingPermitStatus));
    $('#permitData')
      .find('#buildingPermitReq')
      .val(convertUndefined(json.permits.buildingPermitRequired));
    $('#permitData')
      .find('#buildingInspectionReq')
      .val(convertUndefined(json.permits.buildingInspectionRequired));
    $('#permitData')
      .find('#buildingInspectionStatus')
      .val(convertUndefined(json.permits.buildingInspectionStatus));
    $('#permitData')
      .find('#buildingInspectionLastUpdated')
      .val(json.permits.buildingInspectionLastUpdated);

    $('#permitData')
      .find('#ceilingPermitLastUpdated')
      .val(json.permits.ceiling);
    $('#permitData')
      .find('#ceilingPermitStatus')
      .val(convertUndefined(json.permits.ceilingPermitStatus));
    $('#permitData')
      .find('#ceilingPermitReq')
      .val(convertUndefined(json.permits.ceilingPermitRequired));
    $('#permitData')
      .find('#ceilingInspectionReq')
      .val(convertUndefined(json.permits.ceilingInspectionRequired));
    $('#permitData')
      .find('#ceilingInspectionStatus')
      .val(convertUndefined(json.permits.ceilingInspectionStatus));
    $('#permitData')
      .find('#ceilingInspectionLastUpdated')
      .val(json.permits.ceilingInspectionLastUpdated);

    $('#permitData')
      .find('#mechanicalPermitLastUpdated')
      .val(json.permits.mechanical);
    $('#permitData')
      .find('#mechanicalPermitStatus')
      .val(convertUndefined(json.permits.mechanicalPermitStatus));
    $('#permitData')
      .find('#mechanicalPermitReq')
      .val(convertUndefined(json.permits.mechanicalPermitRequired));
    $('#permitData')
      .find('#mechanicalInspectionReq')
      .val(convertUndefined(json.permits.mechanicalInspectionRequired));
    $('#permitData')
      .find('#mechanicalInspectionStatus')
      .val(convertUndefined(json.permits.mechanicalInspectionStatus));
    $('#permitData')
      .find('#mechanicalInspectionLastUpdated')
      .val(json.permits.mechanicalInspectionLastUpdated);

    $('#permitData')
      .find('#electricalPermitLastUpdated')
      .val(json.permits.electrical);
    $('#permitData')
      .find('#electricalPermitStatus')
      .val(convertUndefined(json.permits.electricalPermitStatus));
    $('#permitData')
      .find('#electricalPermitReq')
      .val(convertUndefined(json.permits.electricalPermitRequired));
    $('#permitData')
      .find('#electricalInspectionReq')
      .val(convertUndefined(json.permits.electricalInspectionRequired));
    $('#permitData')
      .find('#electricalInspectionStatus')
      .val(convertUndefined(json.permits.electricalInspectionStatus));
    $('#permitData')
      .find('#electricalInspectionLastUpdated')
      .val(json.permits.electricalInspectionLastUpdated);

    $('#permitData')
      .find('#plumbingPermitLastUpdated')
      .val(json.permits.plumbing);
    $('#permitData')
      .find('#plumbingPermitStatus')
      .val(convertUndefined(json.permits.plumbingPermitStatus));
    $('#permitData')
      .find('#plumbingPermitReq')
      .val(convertUndefined(json.permits.plumbingPermitRequired));
    $('#permitData')
      .find('#plumbingInspectionReq')
      .val(convertUndefined(json.permits.plumbingInspectionRequired));
    $('#permitData')
      .find('#plumbingInspectionStatus')
      .val(convertUndefined(json.permits.plumbingInspectionStatus));
    $('#permitData')
      .find('#plumbingInspectionLastUpdated')
      .val(json.permits.plumbingInspectionLastUpdated);

    $('#permitData').find('#gasPermitLastUpdated').val(json.permits.gas);
    $('#permitData')
      .find('#gasPermitStatus')
      .val(convertUndefined(json.permits.gasPermitStatus));
    $('#permitData')
      .find('#gasPermitReq')
      .val(convertUndefined(json.permits.gasPermitRequired));
    $('#permitData')
      .find('#gasInspectionReq')
      .val(convertUndefined(json.permits.gasInspectionRequired));
    $('#permitData')
      .find('#gasInspectionStatus')
      .val(convertUndefined(json.permits.gasInspectionStatus));
    $('#permitData')
      .find('#gasInspectionLastUpdated')
      .val(json.permits.gasInspectionLastUpdated);

    $('#permitData')
      .find('#sprinklerPermitLastUpdated')
      .val(json.permits.fire_sprinkler);
    $('#permitData')
      .find('#sprinklerPermitStatus')
      .val(convertUndefined(json.permits.sprinklerPermitStatus));
    $('#permitData')
      .find('#sprinklerPermitReq')
      .val(convertUndefined(json.permits.sprinklerPermitRequired));
    $('#permitData')
      .find('#sprinklerInspectionReq')
      .val(convertUndefined(json.permits.sprinklerInspectionRequired));
    $('#permitData')
      .find('#sprinklerInspectionStatus')
      .val(convertUndefined(json.permits.sprinklerInspectionStatus));
    $('#permitData')
      .find('#sprinklerInspectionLastUpdated')
      .val(json.permits.sprinklerInspectionLastUpdated);

    $('#permitData')
      .find('#fireAlarmPermitLastUpdated')
      .val(json.permits.fire_alarm);
    $('#permitData')
      .find('#fireAlarmPermitStatus')
      .val(convertUndefined(json.permits.fireAlarmPermitStatus));
    $('#permitData')
      .find('#fireAlarmPermitReq')
      .val(convertUndefined(json.permits.fireAlarmPermitRequired));
    $('#permitData')
      .find('#fireAlarmInspectionReq')
      .val(convertUndefined(json.permits.fireAlarmInspectionRequired));
    $('#permitData')
      .find('#fireAlarmInspectionStatus')
      .val(convertUndefined(json.permits.fireAlarmInspectionStatus));
    $('#permitData')
      .find('#fireAlarmInspectionLastUpdated')
      .val(json.permits.fireAlarmInspectionLastUpdated);

    $('#permitData')
      .find('#voltagePermitLastUpdated')
      .val(json.permits.low_voltage);
    $('#permitData')
      .find('#voltagePermitStatus')
      .val(convertUndefined(json.permits.voltagePermitStatus));
    $('#permitData')
      .find('#voltagePermitReq')
      .val(convertUndefined(json.permits.voltagePermitRequired));
    $('#permitData')
      .find('#voltageInspectionReq')
      .val(convertUndefined(json.permits.voltageInspectionRequired));
    $('#permitData')
      .find('#voltageInspectionStatus')
      .val(convertUndefined(json.permits.voltageInspectionStatus));
    $('#permitData')
      .find('#voltageInspectionLastUpdated')
      .val(json.permits.voltageInspectionLastUpdated);

    $('#permitData')
      .find('#tempCertOccupancyPermitLastUpdated')
      .val(json.permits.tempCertOccupancy);
    $('#permitData')
      .find('#tempCertOccupancyPermitStatus')
      .val(convertUndefined(json.permits.tempCertOccupancyPermitStatus));
    $('#permitData')
      .find('#tempCertOccupancyPermitReq')
      .val(convertUndefined(json.permits.tempCertOccupancyPermitRequired));
    $('#permitData')
      .find('#tempCertOccupancyInspectionReq')
      .val(convertUndefined(json.permits.tempCertOccupancyInspectionRequired));
    $('#permitData')
      .find('#tempCertOccupancyInspectionStatus')
      .val(convertUndefined(json.permits.tempCertOccupancyInspectionStatus));
    $('#permitData')
      .find('#tempCertOccupancyInspectionLastUpdated')
      .val(json.permits.tempCertOccupancyInspectionLastUpdated);

    $('#permitData')
      .find('#otherAPermitStatus')
      .val(convertUndefined(json.permits.otherAPermitStatus));
    $('#permitData')
      .find('#otherAPermitLastUpdated')
      .val(json.permits.otherAPermit);
    ...
    $('#permitData')
      .find('#otherAInspectionStatus')
      .val(convertUndefined(json.permits.otherAInspectionStatus));
    $('#permitData')
      .find('#otherAInspectionLastUpdated')
      .val(json.permits.otherAInspectionLastUpdated);

    $('#permitData')
      .find('#otherBPermitStatus')
      .val(convertUndefined(json.permits.otherBPermitStatus));
    $('#permitData')
      .find('#otherBPermitLastUpdated')
      .val(json.permits.otherBPermit);
    ...
    $('#permitData')
      .find('#otherBInspectionStatus')
      .val(convertUndefined(json.permits.otherBInspectionStatus));
    $('#permitData')
      .find('#otherBInspectionLastUpdated')
      .val(json.permits.otherBInspectionLastUpdated);

    console.log(json.permits.permitNotes);
    console.log(json.permits.inspectionNotes);
    formatRelativeTextAreas(
      json.permits.permitNotes,
      'permitNotes',
      'permitData'
    );
...
function fillTabs_PERMIT1(data) {
  ...
  if (json.permits != null) {
    ...
    $('#buildingPermitStatus_1').val(
      convertUndefined(json.permits.buildingPermitStatus)
    );
    $('#buildingPermitRequired_1').val(
      convertUndefined(json.permits.buildingPermitRequired)
    );
    $('#buildingInspectionRequired_1').val(
      convertUndefined(json.permits.buildingInspectionRequired)
    );
    $('#buildingInspectionStatus_1').val(
      convertUndefined(json.permits.buildingInspectionStatus)
    );
    $('#buildingInspectionLastUpdated_1').val(
      json.permits.buildingInspectionLastUpdated
    );

    $('#ceilingPermitLastUpdated_1').val(json.permits.ceiling);
    $('#ceilingPermitStatus_1').val(
      convertUndefined(json.permits.ceilingPermitStatus)
    );
    $('#ceilingPermitRequired_1').val(
      convertUndefined(json.permits.ceilingPermitRequired)
    );
    $('#ceilingInspectionRequired_1').val(
      convertUndefined(json.permits.ceilingInspectionRequired)
    );
    $('#ceilingInspectionStatus_1').val(
      convertUndefined(json.permits.ceilingInspectionStatus)
    );
    $('#ceilingInspectionLastUpdated_1').val(
      json.permits.ceilingInspectionLastUpdated
    );

    $('#mechanicalPermitLastUpdated_1').val(json.permits.mechanical);
    $('#mechanicalPermitStatus_1').val(
      convertUndefined(json.permits.mechanicalPermitStatus)
    );
    $('#mechanicalPermitRequired_1').val(
      convertUndefined(json.permits.mechanicalPermitRequired)
    );
    $('#mechanicalInspectionRequired_1').val(
      convertUndefined(json.permits.mechanicalInspectionRequired)
    );
    $('#mechanicalInspectionStatus_1').val(
      convertUndefined(json.permits.mechanicalInspectionStatus)
    );
    $('#mechanicalInspectionLastUpdated_1').val(
      json.permits.mechanicalInspectionLastUpdated
    );

    $('#electricalPermitLastUpdated_1').val(json.permits.electrical);
    $('#electricalPermitStatus_1').val(
      convertUndefined(json.permits.electricalPermitStatus)
    );
    $('#electricalPermitRequired_1').val(
      convertUndefined(json.permits.electricalPermitRequired)
    );
    $('#electricalInspectionRequired_1').val(
      convertUndefined(json.permits.electricalInspectionRequired)
    );
    $('#electricalInspectionStatus_1').val(
      convertUndefined(json.permits.electricalInspectionStatus)
    );
    $('#electricalInspectionLastUpdated_1').val(
      json.permits.electricalInspectionLastUpdated
    );

    $('#plumbingPermitLastUpdated_1').val(json.permits.plumbing);
    $('#plumbingPermitStatus_1').val(
      convertUndefined(json.permits.plumbingPermitStatus)
    );
    $('#plumbingPermitRequired_1').val(
      convertUndefined(json.permits.plumbingPermitRequired)
    );
    $('#plumbingInspectionRequired_1').val(
      convertUndefined(json.permits.plumbingInspectionRequired)
    );
    $('#plumbingInspectionStatus_1').val(
      convertUndefined(json.permits.plumbingInspectionStatus)
    );
    $('#plumbingInspectionLastUpdated_1').val(
      json.permits.plumbingInspectionLastUpdated
    );

    $('#gasPermitLastUpdated_1').val(json.permits.gas);
    $('#gasPermitStatus_1').val(convertUndefined(json.permits.gasPermitStatus));
    $('#gasPermitRequired_1').val(
      convertUndefined(json.permits.gasPermitRequired)
    );
    $('#gasInspectionRequired_1').val(
      convertUndefined(json.permits.gasInspectionRequired)
    );
    $('#gasInspectionStatus_1').val(
      convertUndefined(json.permits.gasInspectionStatus)
    );
    ...
    $('#sprinklerPermitStatus_1').val(
      convertUndefined(json.permits.sprinklerPermitStatus)
    );
    $('#sprinklerPermitRequired_1').val(
      convertUndefined(json.permits.sprinklerPermitRequired)
    );
    $('#sprinklerInspectionRequired_1').val(
      convertUndefined(json.permits.sprinklerInspectionRequired)
    );
    $('#sprinklerInspectionStatus_1').val(
      convertUndefined(json.permits.sprinklerInspectionStatus)
    );
    $('#sprinklerInspectionLastUpdated_1').val(
      json.permits.sprinklerInspectionLastUpdated
    );

    $('#fireAlarmPermitLastUpdated_1').val(json.permits.fire_alarm);
    $('#fireAlarmPermitStatus_1').val(
      convertUndefined(json.permits.fireAlarmPermitStatus)
    );
    $('#fireAlarmPermitRequired_1').val(
      convertUndefined(json.permits.fireAlarmPermitRequired)
    );
    $('#fireAlarmInspectionRequired_1').val(
      convertUndefined(json.permits.fireAlarmInspectionRequired)
    );
    $('#fireAlarmInspectionStatus_1').val(
      convertUndefined(json.permits.fireAlarmInspectionStatus)
    );
    $('#fireAlarmInspectionLastUpdated_1').val(
      json.permits.fireAlarmInspectionLastUpdated
    );

    $('#lowVoltagePermitLastUpdated_1').val(json.permits.low_voltage);
    $('#lowVoltagePermitStatus_1').val(
      convertUndefined(json.permits.voltagePermitStatus)
    );
    $('#lowVoltagePermitRequired_1').val(
      convertUndefined(json.permits.voltagePermitRequired)
    );
    $('#lowVoltageInspectionRequired_1').val(
      convertUndefined(json.permits.voltageInspectionRequired)
    );
    $('#lowVoltageInspectionStatus_1').val(
      convertUndefined(json.permits.voltageInspectionStatus)
    );
    $('#lowVoltageInspectionLastUpdated_1').val(
      json.permits.voltageInspectionLastUpdated
    );

    $('#tempCertOccupancyPermitLastUpdated_1').val(
      json.permits.tempCertOccupancy
    );
    $('#tempCertOccupancyPermitStatus_1').val(
      convertUndefined(json.permits.tempCertOccupancyPermitStatus)
    );
    $('#tempCertOccupancyPermitRequired_1').val(
      convertUndefined(json.permits.tempCertOccupancyPermitRequired)
    );
    $('#tempCertOccupancyInspectionRequired_1').val(
      convertUndefined(json.permits.tempCertOccupancyInspectionRequired)
    );
    $('#tempCertOccupancyInspectionStatus_1').val(
      convertUndefined(json.permits.tempCertOccupancyInspectionStatus)
    );
    $('#tempCertOccupancyInspectionLastUpdated_1').val(
      json.permits.tempCertOccupancyInspectionLastUpdated
    );

    $('#certOccupancyPermitLastUpdated_1').val(json.permits.certOccupancy);
    $('#certOccupancyPermitStatus_1').val(
      convertUndefined(json.permits.certOccupancyPermitStatus)
    );
    $('#certOccupancyPermitRequired_1').val(
      convertUndefined(json.permits.certOccupancyPermitRequired)
    );
    $('#certOccupancyInspectionRequired_1').val(
      convertUndefined(json.permits.certOccupancyInspectionRequired)
    );
    $('#certOccupancyInspectionStatus_1').val(
      convertUndefined(json.permits.certOccupancyInspectionStatus)
    );
    $('#certOccupancyInspectionLastUpdated_1').val(
      json.permits.certOccupancyInspectionLastUpdated
    );
...
function saveProject_PERMIT1() {
  ...
  var buildingInspectionLastUpdated = $(
    '#buildingInspectionLastUpdated_1'
  ).val();
  ...
  var mechanicalInspectionLastUpdated = $(
    '#mechanicalInspectionLastUpdated_1'
  ).val();
  ...
  var electricalInspectionLastUpdated = $(
    '#electricalInspectionLastUpdated_1'
  ).val();
  ...
  var plumbingInspectionLastUpdated = $(
    '#plumbingInspectionLastUpdated_1'
  ).val();
  ...
  var sprinklerInspectionLastUpdated = $(
    '#sprinklerInspectionLastUpdated_1'
  ).val();
  ...
  var fireAlarmInspectionLastUpdated = $(
    '#fireAlarmInspectionLastUpdated_1'
  ).val();
  ...
  var voltageInspectionLastUpdated = $(
    '#lowVoltageInspectionLastUpdated_1'
  ).val();

  var tempCertOccupancyPermitReq = $(
    '#tempCertOccupancyPermitRequired_1'
  ).val();
  var tempCertOccupancyPermitStatus = $(
    '#tempCertOccupancyPermitStatus_1'
  ).val();
  var tempCertOccupancyPermitLastUpdated = $(
    '#tempCertOccupancyPermitLastUpdated_1'
  ).val();
  var tempCertOccupancyInspectionReq = $(
    '#tempCertOccupancyInspectionRequired_1'
  ).val();
  var tempCertOccupancyInspectionStatus = $(
    '#tempCertOccupancyInspectionStatus_1'
  ).val();
  var tempCertOccupancyInspectionLastUpdated = $(
    '#tempCertOccupancyInspectionLastUpdated_1'
  ).val();
  ...
  var certOccupancyPermitLastUpdated = $(
    '#certOccupancyPermitLastUpdated_1'
  ).val();
  var certOccupancyInspectionReq = $(
    '#certOccupancyInspectionRequired_1'
  ).val();
  var certOccupancyInspectionStatus = $(
    '#certOccupancyInspectionStatus_1'
  ).val();
  var certOccupancyInspectionLastUpdated = $(
    '#certOccupancyInspectionLastUpdated_1'
  ).val();
  ...
  var otherAInspectionLastUpdated = $(
    '#lowVoltageInspectionLastUpdated_1'
  ).val();
  ...
  var otherBInspectionLastUpdated = $(
    '#lowVoltageInspectionLastUpdated_1'
  ).val();
  ...
  var dates_PERMIT = [
    buildingPermitLastUpdated,
    buildingInspectionLastUpdated,
    ceilingPermitLastUpdated,
    ceilingInspectionLastUpdated,
    mechanicalPermitLastUpdated,
    mechanicalInspectionLastUpdated,
    electricalPermitLastUpdated,
    electricalInspectionLastUpdated,
    plumbingPermitLastUpdated,
    plumbingInspectionLastUpdated,
    gasPermitLastUpdated,
    gasInspectionLastUpdated,
    sprinklerPermitLastUpdated,
    sprinklerInspectionLastUpdated,
    fireAlarmPermitLastUpdated,
    fireAlarmInspectionLastUpdated,
    voltagePermitLastUpdated,
    voltageInspectionLastUpdated,
    tempCertOccupancyPermitLastUpdated,
    tempCertOccupancyInspectionLastUpdated,
    certOccupancyPermitLastUpdated,
    certOccupancyInspectionLastUpdated,
    //buildPermExpireDate,
    otherAPermitLastUpdated,
    otherAInspectionLastUpdated,
    otherBPermitLastUpdated,
    otherBInspectionLastUpdated,
  ];
  ...
  if (isValidInput_PERMIT(dates_PERMIT)) {
    ...
    var action = 'editPermits';
    var PERMIT_ID = 0;
    if (PROJECT_DATA.permits != null) PERMIT_ID = PROJECT_DATA.permits.id;
    else PERMIT_ID = 0;
...
$(document).ready(function () {
  $('#projectData')
    ...
    .click(function () {
      if (
        $(this).attr('id') !== 'saveProjectLink' &&
        $(this).attr('id') !== 'genFailedRules'
      ) {
  ...
  $('#projectData')
    .find('#pendingInvoiceCreationZone')
    .find('#submittedDatePend')
    .datepicker();
  $('#projectData')
    .find('#invoiceCreationZone')
    .find('#submittedDateInv')
    .datepicker();
  $('#projectData')
    .find('#invoiceCreationZone')
    .find('#submitRejectDate')
    .datepicker();
});
...
function generateDropdowns(str, className) {
  ...
  for (var i = 0; i < json.length; i++) {
    ...
    if (className == 'closeoutstatus') {
      ...
      if (
        json[i].state &&
        (json[i].state == 'UNKNOWN' || json[i].state == 'Unknown')
      ) {
        ...
        option.innerHTML =
          json[i].city.name +
          ', ' +
          toTitleCase(json[i].state.replace('_', ' '));
      }
...
function changeOrderHVAC(temp) {
  ...
  if ($('#projectData').find('#autofill-HVAC').val() == '1' || temp == 1) {
    var choice = window.confirm(
      'Would you like to generate a change order for HVAC?'
    );
    ...
    if (choice === true) {
      ...
      $('#changeOrder')
        ...
        .val('Revisions for pass thru items');
      ...
      if (PROJECT_DATA.changeOrders.length != 0) {
        $('#changeOrder')
          .find('#mcsCO')
          .val(PROJECT_DATA.changeOrders.length + 1);
      } else {
...
function autofillRefrigeration() {
  var autofill_Refrigeration = $('#projectData')
    .find('#autofill-Refrigeration')
    .val();
...
function changeOrderRefrigeration(temp) {
  ...
  if (
    $('#projectData').find('#autofill-Refrigeration').val() == '1' ||
    temp == 1
  ) {
    var choice = window.confirm(
      'Would you like to generate a change order for Refrigeration?'
    );
    ...
    if (choice === true) {
      ...
      $('#changeOrder')
        .find('#title')
        .val('Refrigeration Travel, Rentals, and Freight');
...
function saveProject_PROJECT_DATA() {
  ...
  var budgetarySubmitted = $('#projectData')
    .find('#budgetarySubmittedDate')
    .val();
  ...
  if (cost) {
    cost = cleanNumericValueForSaving(
      $('#projectData').find('#projectCost')[0].value
    );
  ...
  if (isValidInput_PROJECT_DATA(required, dates_PROJECT_DATA)) {
    for (var i = 0; i < dates_PROJECT_DATA.length; i++) {
      if (dates_PROJECT_DATA[i])
        dates_PROJECT_DATA[i] = dateCleaner(dates_PROJECT_DATA[i]);
...
function fillForm_PROJECT_DATA(data) {
  ...
  else $('#generalInformation').find('#autofill-HVAC').val('default');

  if (data.autofillRefrigeration != undefined)
    $('#generalInformation')
      .find('#autofill-Refrigeration')
      .val(data.autofillRefrigeration);
  else $('#generalInformation').find('#autofill-Refrigeration').val('default');

  if (data.autofillPermits != undefined)
    $('#generalInformation')
      .find('#autofill-Permits')
      .val(data.autofillPermits);
  else $('#generalInformation').find('#autofill-Permits').val('default');
}
...
function hasStage(stageList, stage) {
  for (var i = 0; i < stageList.length; i++) {
    if (stageList[i] == stage) return true;
  }
...
$(document).ready(function () {
  ...
  $('#scorecardTabLink').click(function () {
    ...
    if (
      PROJECT_DATA.stage.name == 'Canceled' ||
      PROJECT_DATA.stage.name == 'On Hold'
    ) {
      $('#scoreCardDiv').show();
      ...
      emptyingTables();
      scoreBackground(
        ['#59ba63', PROJECT_DATA.stage.name],
        ['#59ba63', ''],
        ['#59ba63', ''],
        ['#59ba63', ''],
        ['#59ba63', ''],
...
function createTask() {
  ...
  $('#tasksInformation')
    .find('#taskCreationZone')
    .find('#taskStatusSelectionRow')
    .show();
...
function viewTasks() {
  ...
  let createMessage =
    'This task will not be added, are you sure you want to leave this screen?';
  let displayedMessage;

  if (TASK_ACTION == 'createTask') displayedMessage = createMessage;
...
function prepareProjectData(source_id) {
  ...
  $('#projectData')
    .find('#financialInformation')
    .find('#financialInformationTable')
    .hide();
  ...
  //makes account payable active
    ...
    $('#projectData')
      .find('.nav-tabs')
      .find('[data-tab=pendingInvoiceInformation]')
      .addClass('active');
    ...
    $('#projectData')
      .find('.nav-tabs')
      .find('[data-tab=customerNotesInformation]')
      .addClass('active');
  ...
  //makes accounts receivable active
    ...
    $('#projectData')
      .find('.nav-tabs')
      .find('[data-tab=peInvoiceInformation]')
      .addClass('active');
...
function prepareCloseout(source_id) {
  ...
  if (source_id == 'closeout-documents-item') {
    $('#closeoutData')
      .find('.nav-tabs')
      .find('[data-tab=closeoutDocuments]')
      .addClass('active');
...
function addEquipment() {
  ...
  $('#equipmentDiv')
    .find('.nav-tabs')
    .find('[data-tab=saveButton]')
    .removeClass('active');
  $('#equipmentDiv')
    .find('.nav-tabs')
    .find('[data-tab=equipmentForm]')
    .addClass('active');
...
function addEquipmentProposals() {
  ...
  $('#equipmentDivProposals')
    .find('.nav-tabs')
    .find('[data-tab=saveButtonProposals]')
    .removeClass('active');
  $('#equipmentDivProposals')
    .find('.nav-tabs')
    .find('[data-tab=equipmentFormProposals]')
    .addClass('active');
  $('.projectNavigator-projectManager').show();
  $('.projectEdit').show();
  $('.projectNavigator').show();
...
function fillProjectInformation(data) {
  ...
  if (data.supervisors[0]) {
    $('#projectManager')
      .find('#projectSupervisor')
      .text(data.supervisors[0].name);
  }
...
function fillChangeOrders(data) {
  ...
  for (var i = 0; i < changeOrders.length; i++) {
    ...
    if (
      $('#changeOrderSelector').val() == 'preparing' &&
      changeOrders[i].status != '1'
    )
      continue;
    else if (
      $('#changeOrderSelector').val() == 'submitted' &&
      changeOrders[i].status != '2'
    )
      continue;
    else if (
      $('#changeOrderSelector').val() == 'approved' &&
      changeOrders[i].status != '3'
    )
      continue;
    else if (
      $('#changeOrderSelector').val() == 'rejected' &&
      changeOrders[i].status != '4'
    )
      continue;
    else if (
      $('#changeOrderSelector').val() == 'complete' &&
      changeOrders[i].status != '5'
    )
      continue;
    else if (
      $('#changeOrderSelector').val() == 'review' &&
      changeOrders[i].status != '6'
    )
      continue;
    ...
    tableRow.onclick = function () {
      toggleChangeOrder(this);
    };
    tableRow.ondblclick = function () {
      editSelectedChangeOrder(this.value);
    };
    ...
    briefDescription.appendChild(
      document.createTextNode(changeOrder.briefDescription)
    );

    var status = document.createElement('td');
    status.width = '9%';
    status.appendChild(
      document.createTextNode(parseChangeOrderStatus(changeOrder.status))
    );
    ...
    if (MCS_INVOICE_STATUS == '1' && SUB_INVOICE_STATUS == '1') {
      ...
      MCS_INVOICE_STATUS == undefined ||
      SUB_INVOICE_STATUS == undefined
    ) {
      AND_INVOICE_STATUS = '   ';
    ...
    type.width = '10%';
    type.appendChild(
      document.createTextNode(convertChangeOrderType(changeOrder.type))
    );

    var submittedDate = document.createElement('td');
    submittedDate.width = '8%';
    if (changeOrder.submittedDate)
      submittedDate.appendChild(
        document.createTextNode(changeOrder.submittedDate)
      );
    ...
    if (changeOrder.cost)
      cost.appendChild(
        document.createTextNode(
          cleanNumericValueForDisplaying(changeOrder.cost)
        )
      );
    else cost.appendChild(document.createTextNode('---'));
    ...
    if (changeOrder.sell)
      sell.appendChild(
        document.createTextNode(
          cleanNumericValueForDisplaying(changeOrder.sell)
        )
      );
    else sell.appendChild(document.createTextNode('---'));
...
function convertChangeOrderType(type, co) {
  ...
  for (var i = 0; i < CHANGE_ORDER_TYPES.length; i++) {
    if (CHANGE_ORDER_TYPES[i].id == type) return CHANGE_ORDER_TYPES[i].name;
  }
...
function convertRequired(req) {
  if (req == 'default' || req == undefined || req == null) return '';
  else if (req == '2') return 'No';
  else if (req == '1') return 'Yes';
  else if (req == '0') return 'TBD';
  else return;
}

function convertStatus(status) {
  if (status == 'default' || status == undefined) return '';
...
function fillPermitsAndInspections(data) {
  ...
  // permits
  $('#projectManager')
    .find('#buildingPermitRequired')
    .text(convertRequired(tabData.buildingPermitRequired));
  $('#projectManager').find('#buildingPermitDate').text(tabData.building);
  $('#projectManager')
    .find('#buildingPermit')
    .text(convertStatus(tabData.buildingPermitStatus));

  $('#projectManager')
    .find('#ceilingPermitRequired')
    .text(convertRequired(tabData.ceilingPermitRequired));
  $('#projectManager').find('#ceilingPermitDate').text(tabData.ceiling);
  $('#projectManager')
    .find('#ceilingPermit')
    .text(convertStatus(tabData.ceilingPermitStatus));

  $('#projectManager')
    .find('#mechanicalPermitRequired')
    .text(convertRequired(tabData.mechanicalPermitRequired));
  $('#projectManager').find('#mechanicalPermitDate').text(tabData.mechanical);
  $('#projectManager')
    .find('#mechanicalPermit')
    .text(convertStatus(tabData.mechanicalPermitStatus));

  $('#projectManager')
    .find('#electricalPermitRequired')
    .text(convertRequired(tabData.electricalPermitRequired));
  $('#projectManager').find('#electricalPermitDate').text(tabData.electrical);
  $('#projectManager')
    .find('#electricalPermit')
    .text(convertStatus(tabData.electricalPermitStatus));

  $('#projectManager')
    .find('#plumbingPermitRequired')
    .text(convertRequired(tabData.plumbingPermitRequired));
  $('#projectManager').find('#plumbingPermitDate').text(tabData.plumbing);
  $('#projectManager')
    .find('#plumbingPermit')
    .text(convertStatus(tabData.plumbingPermitStatus));

  $('#projectManager')
    .find('#gasPermitRequired')
    .text(convertRequired(tabData.gasPermitRequired));
  $('#projectManager').find('#gasPermitDate').text(tabData.gas);
  $('#projectManager')
    .find('#gasPermit')
    .text(convertStatus(tabData.gasPermitStatus));

  $('#projectManager')
    .find('#sprinklerPermitRequired')
    .text(convertRequired(tabData.sprinklerPermitRequired));
  $('#projectManager')
    .find('#sprinklerPermitDate')
    .text(tabData.fire_sprinkler);
  $('#projectManager')
    .find('#sprinklerPermit')
    .text(convertStatus(tabData.sprinklerPermitStatus));

  $('#projectManager')
    .find('#fireAlarmPermitRequired')
    .text(convertRequired(tabData.fireAlarmPermitRequired));
  $('#projectManager').find('#fireAlarmPermitDate').text(tabData.fire_alarm);
  $('#projectManager')
    .find('#fireAlarmPermit')
    .text(convertStatus(tabData.fireAlarmPermitStatus));

  $('#projectManager')
    .find('#lowVoltagePermitRequired')
    .text(convertRequired(tabData.voltagePermitRequired));
  $('#projectManager').find('#lowVoltagePermitDate').text(tabData.low_voltage);
  $('#projectManager')
    .find('#lowVoltagePermit')
    .text(convertStatus(tabData.voltagePermitStatus));

  $('#projectManager')
    .find('#tempCertOccupancyPermitRequired')
    .text(convertRequired(tabData.tempCertOccupancyPermitRequired));
  $('#projectManager')
    .find('#tempCertOccupancyPermitDate')
    .text(tabData.tempCertOccupancy);
  $('#projectManager')
    .find('#tempCertOccupancyPermit')
    .text(convertStatus(tabData.tempCertOccupancyPermitStatus));

  //Required
  $('#projectManager')
    .find('#certOccupancyPermitRequired')
    .text(convertRequired(tabData.certOccupancyPermitRequired));
  $('#projectManager')
    .find('#certOccupancyPermitDate')
    .text(tabData.certOccupancy);
  $('#projectManager')
    .find('#certOccupancyPermit')
    .text(convertStatus(tabData.certOccupancyPermitStatus));

  // inspections
  $('#projectManager')
    .find('#buildingInspectionRequired')
    .text(convertRequired(tabData.buildingInspectionRequired));
  $('#projectManager')
    .find('#buildingInspectionDate')
    .text(tabData.buildingInspectionLastUpdated);
  $('#projectManager')
    .find('#buildingInspection')
    .text(convertStatus(tabData.buildingInspectionStatus));

  $('#projectManager')
    .find('#ceilingInspectionRequired')
    .text(convertRequired(tabData.ceilingInspectionRequired));
  $('#projectManager')
    .find('#ceilingInspectionDate')
    .text(tabData.ceilingInspectionLastUpdated);
  $('#projectManager')
    .find('#ceilingInspection')
    .text(convertStatus(tabData.ceilingInspectionStatus));

  $('#projectManager')
    .find('#mechanicalInspectionRequired')
    .text(convertRequired(tabData.mechanicalInspectionRequired));
  $('#projectManager')
    .find('#mechanicalInspectionDate')
    .text(tabData.mechanicalInspectionLastUpdated);
  $('#projectManager')
    .find('#mechanicalInspection')
    .text(convertStatus(tabData.mechanicalInspectionStatus));

  $('#projectManager')
    .find('#electricalInspectionRequired')
    .text(convertRequired(tabData.electricalInspectionRequired));
  $('#projectManager')
    .find('#electricalInspectionDate')
    .text(tabData.electricalInspectionLastUpdated);
  $('#projectManager')
    .find('#electricalInspection')
    .text(convertStatus(tabData.electricalInspectionStatus));

  $('#projectManager')
    .find('#plumbingInspectionRequired')
    .text(convertRequired(tabData.plumbingInspectionRequired));
  $('#projectManager')
    .find('#plumbingInspectionDate')
    .text(tabData.plumbingInspectionLastUpdated);
  $('#projectManager')
    .find('#plumbingInspection')
    .text(convertStatus(tabData.plumbingInspectionStatus));

  $('#projectManager')
    .find('#gasInspectionRequired')
    .text(convertRequired(tabData.gasInspectionRequired));
  $('#projectManager')
    .find('#gasInspectionDate')
    .text(tabData.gasInspectionLastUpdated);
  $('#projectManager')
    .find('#gasInspection')
    .text(convertStatus(tabData.gasInspectionStatus));

  $('#projectManager')
    .find('#sprinklerInspectionRequired')
    .text(convertRequired(tabData.sprinklerInspectionRequired));
  $('#projectManager')
    .find('#sprinklerInspectionDate')
    .text(tabData.sprinklerInspectionLastUpdated);
  $('#projectManager')
    .find('#sprinklerInspection')
    .text(convertStatus(tabData.sprinklerInspectionStatus));

  $('#projectManager')
    .find('#fireAlarmInspectionRequired')
    .text(convertRequired(tabData.fireAlarmInspectionRequired));
  $('#projectManager')
    .find('#fireAlarmInspectionDate')
    .text(tabData.fireAlarmInspectionLastUpdated);
  $('#projectManager')
    .find('#fireAlarmInspection')
    .text(convertStatus(tabData.fireAlarmInspectionStatus));

  $('#projectManager')
    .find('#lowVoltageInspectionRequired')
    .text(convertRequired(tabData.fireAlarmInspectionRequired));
  $('#projectManager')
    .find('#lowVoltageInspectionDate')
    .text(tabData.voltageInspectionLastUpdated);
  $('#projectManager')
    .find('#lowVoltageInspection')
    .text(convertStatus(tabData.voltageInspectionStatus));

  $('#projectManager')
    .find('#tempCertOccupancyInspectionRequired')
    .text(convertRequired(tabData.tempCertOccupancyInspectionRequired));
  $('#projectManager')
    .find('#tempCertOccupancyInspectionDate')
    .text(tabData.tempCertOccupancyInspectionLastUpdated);
  $('#projectManager')
    .find('#tempCertOccupancyInspection')
    .text(convertStatus(tabData.tempCertOccupancyInspectionStatus));

  //Required
  $('#projectManager')
    .find('#certOccupancyInspectionRequired')
    .text(convertRequired(tabData.certOccupancyInspectionRequired));
  $('#projectManager')
    .find('#certOccupancyInspectionDate')
    .text(tabData.certOccupancyInspectionLastUpdated);
  $('#projectManager')
    .find('#certOccupancyInspection')
    .text(convertStatus(tabData.certOccupancyInspectionStatus));
...
function fillEquipment(data) {
  ...
  for (var i = 0; i < equipmentList.length; i++) {
    ...
    tableRow.ondblclick = function () {
      editSelectedEquipment(this.value);
    };
    ...
    if (equipment.eqStatus) deliveryStatusText = equipment.eqStatus.name;

    if (
      deliveryStatusText == undefined ||
      deliveryStatusText == 'undefined' ||
      deliveryStatusText == 'default'
    )
      deliveryStatusText = '';
    ...
    var supplierText = '';
    if (equipment.eqSupplier) supplierText = equipment.eqSupplier.name;
    ...
    if (equipment.equipProposalDate === undefined)
      ...
      equipProposalDate.appendChild(
        document.createTextNode(equipment.equipProposalDate)
      );
    ...
    if (equipment.estDeliveryDate === undefined)
      ...
      estDeliveryDate.appendChild(
        document.createTextNode(equipment.estDeliveryDate)
      );
    ...
    } else equipmentQuantity.innerHTML = addingBreaktoHTML(equipment.quantity);
...
function fillEquipmentProposals(data) {
  ...
  for (var i = 0; i < equipmentList.length; i++) {
    ...
    tableRow.setAttribute('value', equipment.id);
    tableRow.onclick = function () {
      toggleEquipmentProposals(this);
    };
    tableRow.ondblclick = function () {
      editSelectedEquipmentProposals(this.value);
    };
...
function fillCloseout(data) {
  ...
  $('#closeoutSummary')
    .find('#mg2Completion')
    .html(closeoutStatusConverter(closeoutData.substantialCompletionStatus));
  $('#closeoutSummary')
    .find('#punchList')
    .html(closeoutStatusConverter(closeoutData.punchListStatus));
  $('#closeoutSummary')
    .find('#verisaeReport')
    .html(closeoutStatusConverter(closeoutData.verisaeReportStatus));
...
function closeoutStatusConverter(param) {
  if (param == 1) return 'Complete';
  else if (param == 2) return 'Incomplete';
  else if (param == 3) return 'N/A';
  else if (param == 4) return 'Required';
  else if (param == 6) return 'TBD';
  else return '---';
}
...
function convertPermit(param) {
  if (param == '1') return 'Preparing';
  else if (param == '2') return 'Submitted';
  else if (param == '3') return 'Issued';
  else if (param == '4') return 'Closed';
  else return '---';
}
    ...
    success: function (data) {
      ...
      if (user.permission.canDeleteProjects == true) {
        ...
        if (tasksExist == 0) {
          ...
          alert(
            'This project has Tasks associated with it and hence cannot be deleted'
          );
        }
  ...
  if (confirm('Are you sure you want to delete this project permanently?')) {
    $.ajax({
      ...
      complete: function (data) {
        ...
        } else alert('Could not Delete Project');
      },
    });
  }
}
...
function fillTasksTable(tasks) {
  ...
  for (var i = 0; i < tasks.length; i++) {
    if (
      (selector === 'open' && tasks[i].status.id != 1) ||
...
function fillTaskWell(source) {
  ...
  $('#taskCreationZone')
    .find('#descriptionEntry')
    .val(selected_task.description);
  ...
  if (selected_task.type == TASK_SUB_ASSIGNEE) {
    ...
    $('#taskCreationZone')
      .find('#subcontractorsDropdown')
      .val(selected_task.subAssignee.name);
  } else {
    ...
    $('#taskCreationZone')
      .find('#assigneeEntry')
      .val(selected_task.assignee.firstName);
    $('#taskCreationZone')
      .find('#subcontractorsDropdown')
      .val(selected_task.subAssignee.name);
  }
...
function fillDropdownsCostEst(json) {
  ...
  if (costEstData.length > 0) fillCostEstEditor(costEstData);
}
...
function fillCostEstEditor(data) {
  ...
  $('#costEstimateData')
    .find('#genConProposalReq')
    .val(checkDefault(data.genConProposalReq));
  $('#costEstimateData')
    .find('#genConSubName')
    .val(checkDefault(data.genConSubName));
  $('#costEstimateData')
    .find('#genConStatus')
    .val(checkDefault(data.genConStatus));
  ...
  $('#costEstimateData')
    .find('#refrigProposalReq')
    .val(checkDefault(data.refrigProposalReq));
  $('#costEstimateData')
    .find('#refrigSubName')
    .val(checkDefault(data.refrigSubName));
  $('#costEstimateData')
    .find('#refrigStatus')
    .val(checkDefault(data.refrigStatus));
  ...
  $('#costEstimateData')
    .find('#mechanicalProposalReq')
    .val(checkDefault(data.mechanicalProposalReq));
  $('#costEstimateData')
    .find('#mechanicalSubName')
    .val(checkDefault(data.mechanicalSubName));
  $('#costEstimateData')
    .find('#mechanicalStatus')
    .val(checkDefault(data.mechanicalStatus));
  $('#costEstimateData')
    .find('#mechanicalSubmitDate')
    .val(data.mechanicalSubmitDate);
  $('#costEstimateData')
    .find('#mechanicalCost')
    .val(checkCost(data.mechanicalCost));
  ...
  $('#costEstimateData')
    .find('#electricalProposalReq')
    .val(checkDefault(data.electricalProposalReq));
  $('#costEstimateData')
    .find('#electricalSubName')
    .val(checkDefault(data.electricalSubName));
  $('#costEstimateData')
    .find('#electricalStatus')
    .val(checkDefault(data.electricalStatus));
  $('#costEstimateData')
    .find('#electricalSubmitDate')
    .val(data.electricalSubmitDate);
  $('#costEstimateData')
    .find('#electricalCost')
    .val(checkCost(data.electricalCost));
  ...
  $('#costEstimateData')
    .find('#plumbingProposalReq')
    .val(checkDefault(data.plumbingProposalReq));
  $('#costEstimateData')
    .find('#plumbingSubName')
    .val(checkDefault(data.plumbingSubName));
  $('#costEstimateData')
    .find('#plumbingStatus')
    .val(checkDefault(data.plumbingStatus));
  $('#costEstimateData')
    .find('#plumbingSubmitDate')
    .val(data.plumbingSubmitDate);
  $('#costEstimateData')
    .find('#plumbingCost')
    .val(checkCost(data.plumbingCost));
  $('#costEstimateData').find('#plumbingScopeDes').val(data.plumbingScope);
  $('#costEstimateData').find('#plumbingNotes').val(data.plumbingNotes);

  $('#costEstimateData')
    .find('#gasProposalReq')
    .val(checkDefault(data.gasProposalReq));
  ...
  $('#costEstimateData')
    .find('#sprinklerProposalReq')
    .val(checkDefault(data.sprinklerProposalReq));
  $('#costEstimateData')
    .find('#sprinklerSubName')
    .val(checkDefault(data.sprinklerSubName));
  $('#costEstimateData')
    .find('#sprinklerStatus')
    .val(checkDefault(data.sprinklerStatus));
  $('#costEstimateData')
    .find('#sprinklerSubmitDate')
    .val(data.sprinklerSubmitDate);
  $('#costEstimateData')
    .find('#sprinklerCost')
    .val(checkCost(data.sprinklerCost));
  ...
  $('#costEstimateData')
    .find('#fireAlarmProposalReq')
    .val(checkDefault(data.fireAlarmProposalReq));
  $('#costEstimateData')
    .find('#fireAlarmSubName')
    .val(checkDefault(data.fireAlarmSubName));
  $('#costEstimateData')
    .find('#fireAlarmStatus')
    .val(checkDefault(data.fireAlarmStatus));
  $('#costEstimateData')
    .find('#fireAlarmSubmitDate')
    .val(data.fireAlarmSubmitDate);
  $('#costEstimateData')
    .find('#fireAlarmCost')
    .val(checkCost(data.fireAlarmCost));
  ...
  $('#costEstimateData')
    .find('#carpenterProposalReq')
    .val(checkDefault(data.carpenterProposalReq));
  $('#costEstimateData')
    .find('#carpenterSubName')
    .val(checkDefault(data.carpenterSubName));
  $('#costEstimateData')
    .find('#carpenterStatus')
    .val(checkDefault(data.carpenterStatus));
  $('#costEstimateData')
    .find('#carpenterSubmitDate')
    .val(data.carpenterSubmitDate);
  $('#costEstimateData')
    .find('#carpenterCost')
    .val(checkCost(data.carpenterCost));
  ...
  $('#costEstimateData')
    .find('#equipmentProposalReq')
    .val(checkDefault(data.equipmentProposalReq));
  $('#costEstimateData')
    .find('#equipmentSubName')
    .val(checkDefault(data.equipmentSubName));
  $('#costEstimateData')
    .find('#equipmentStatus')
    .val(checkDefault(data.equipmentStatus));
  $('#costEstimateData')
    .find('#equipmentSubmitDate')
    .val(data.equipmentSubmitDate);
  $('#costEstimateData')
    .find('#equipmentCost')
    .val(checkCost(data.equipmentCost));
  ...
  $('#costEstimateData')
    .find('#supervisionProposalReq')
    .val(checkDefault(data.supervisionProposalReq));
  $('#costEstimateData')
    .find('#supervisionSubName')
    .val(checkDefault(data.supervisionSubName));
  $('#costEstimateData')
    .find('#supervisionStatus')
    .val(checkDefault(data.supervisionStatus));
  $('#costEstimateData')
    .find('#supervisionSubmitDate')
    .val(data.supervisionSubmitDate);
  $('#costEstimateData')
    .find('#supervisionCost')
    .val(checkCost(data.supervisionCost));
  $('#costEstimateData')
    .find('#supervisionScopeDes')
    .val(data.supervisionScope);
  $('#costEstimateData').find('#supervisionNotes').val(data.supervisionNotes);

  $('#costEstimateData')
    .find('#profitProposalReq')
    .val(checkDefault(data.profitProposalReq));
  $('#costEstimateData')
    .find('#profitSubName')
    .val(checkDefault(data.profitSubName));
  $('#costEstimateData')
    .find('#profitStatus')
    .val(checkDefault(data.profitStatus));
  ...
  $('#costEstimateData')
    .find('#taxesProposalReq')
    .val(checkDefault(data.taxesProposalReq));
  $('#costEstimateData')
    .find('#taxesSubName')
    .val(checkDefault(data.taxesSubName));
  $('#costEstimateData')
    .find('#taxesStatus')
    .val(checkDefault(data.taxesStatus));
  ...
  $('#costEstimateData')
    .find('#totalProposalReq')
    .val(checkDefault(data.totalProposalReq));
  $('#costEstimateData')
    .find('#totalSubName')
    .val(checkDefault(data.totalSubName));
  $('#costEstimateData')
    .find('#totalStatus')
    .val(checkDefault(data.totalStatus));
...
function saveCostEstimate() {
  ...
  var genConProposalReq = $('#costEstimateData')
    .find('#genConProposalReq')
    .val();
  ...
  var refrigProposalReq = $('#costEstimateData')
    .find('#refrigProposalReq')
    .val();
  ...
  var mechanicalProposalReq = $('#costEstimateData')
    .find('#mechanicalProposalReq')
    .val();
  var mechanicalSubName = $('#costEstimateData')
    .find('#mechanicalSubName')
    .val();
  var mechanicalStatus = $('#costEstimateData').find('#mechanicalStatus').val();
  var mechanicalSubmitDate = $('#costEstimateData')
    .find('#mechanicalSubmitDate')
    .val();
  var mechanicalCost = $('#costEstimateData').find('#mechanicalCost').val();
  var mechanicalScope = $('#costEstimateData')
    .find('#mechanicalScopeDes')
    .val();
  var mechanicalNotes = $('#costEstimateData').find('#mechanicalNotes').val();

  var electricalProposalReq = $('#costEstimateData')
    .find('#electricalProposalReq')
    .val();
  var electricalSubName = $('#costEstimateData')
    .find('#electricalSubName')
    .val();
  var electricalStatus = $('#costEstimateData').find('#electricalStatus').val();
  var electricalSubmitDate = $('#costEstimateData')
    .find('#electricalSubmitDate')
    .val();
  var electricalCost = $('#costEstimateData').find('#electricalCost').val();
  var electricalScope = $('#costEstimateData')
    .find('#electricalScopeDes')
    .val();
  var electricalNotes = $('#costEstimateData').find('#electricalNotes').val();

  var plumbingProposalReq = $('#costEstimateData')
    .find('#plumbingProposalReq')
    .val();
  var plumbingSubName = $('#costEstimateData').find('#plumbingSubName').val();
  var plumbingStatus = $('#costEstimateData').find('#plumbingStatus').val();
  var plumbingSubmitDate = $('#costEstimateData')
    .find('#plumbingSubmitDate')
    .val();
  var plumbingCost = $('#costEstimateData').find('#plumbingCost').val();
  ...
  var sprinklerProposalReq = $('#costEstimateData')
    .find('#sprinklerProposalReq')
    .val();
  ...
  var sprinklerSubmitDate = $('#costEstimateData')
    .find('#sprinklerSubmitDate')
    .val();
  var sprinklerCost = $('#costEstimateData').find('#sprinklerCost').val();
  ...
  var fireAlarmProposalReq = $('#costEstimateData')
    .find('#fireAlarmProposalReq')
    .val();
  ...
  var fireAlarmSubmitDate = $('#costEstimateData')
    .find('#fireAlarmSubmitDate')
    .val();
  var fireAlarmCost = $('#costEstimateData').find('#fireAlarmCost').val();
  ...
  var carpenterProposalReq = $('#costEstimateData')
    .find('#carpenterProposalReq')
    .val();
  ...
  var carpenterSubmitDate = $('#costEstimateData')
    .find('#carpenterSubmitDate')
    .val();
  var carpenterCost = $('#costEstimateData').find('#carpenterCost').val();
  ...
  var equipmentProposalReq = $('#costEstimateData')
    .find('#equipmentProposalReq')
    .val();
  ...
  var equipmentSubmitDate = $('#costEstimateData')
    .find('#equipmentSubmitDate')
    .val();
  var equipmentCost = $('#costEstimateData').find('#equipmentCost').val();
  ...
  var supervisionProposalReq = $('#costEstimateData')
    .find('#supervisionProposalReq')
    .val();
  var supervisionSubName = $('#costEstimateData')
    .find('#supervisionSubName')
    .val();
  var supervisionStatus = $('#costEstimateData')
    .find('#supervisionStatus')
    .val();
  var supervisionSubmitDate = $('#costEstimateData')
    .find('#supervisionSubmitDate')
    .val();
  var supervisionCost = $('#costEstimateData').find('#supervisionCost').val();
  var supervisionScope = $('#costEstimateData')
    .find('#supervisionScopeDes')
    .val();
  var supervisionNotes = $('#costEstimateData').find('#supervisionNotes').val();

  var profitProposalReq = $('#costEstimateData')
    .find('#profitProposalReq')
    .val();
  ...
  var dates_CostEst = [
    genConSubmitDate,
    refrigSubmitDate,
    mechanicalSubmitDate,
    electricalSubmitDate,
    plumbingSubmitDate,
    gasSubmitDate,
    sprinklerSubmitDate,
    fireAlarmSubmitDate,
  ...
  if (isValidInput_PERMIT(dates_CostEst)) {
    ...
    for (var i = 0; i < dates_CostEst.length; i++) {
      if (dates_CostEst[i]) dates_CostEst[i] = dateCleaner(dates_CostEst[i]);
...
function convertProposalReq(data) {
  ...
  else if (data == '2') return 'No';
  else if (data == '3') return 'TBD';
  return '';
}

function convertSubName(data) {
  console.log(data);
  if (data == '2') return 'Expert Mechanical';
  else if (data == '4') return 'Heritage';
  else if (data == '5') return 'Harrisonburg Construction';
  else if (data == '6') return 'Maser Consulting';
  else if (data == '7') return 'MG2';
  else if (data == '8') return 'The Darcy Company';
  else if (data == '9') return 'TEI';
  else if (data == '10') return 'Blauch Brothers';
  else if (data == '11') return 'Costco';
  else if (data == '12') return 'Sciarretti';
  else if (data == '13') return 'GES';
  else if (data == '14') return 'BRR';
  else if (data == '15') return 'Crosbybrownlie';
  else if (data == '16') return 'Dixie';
  else if (data == '17') return 'FDS';
  else if (data == '18') return 'Miller Ref';
  else return '';
}
...
function fillCostEstOverview(data) {
  ...
  $('#costEstimateOverview')
    .find('#genConProposal')
    .text(convertProposalReq(data.genConProposalReq));
  $('#costEstimateOverview')
    .find('#genConSub')
    .text(convertSubName(data.genConSubName));
  $('#costEstimateOverview')
    .find('#genConCostO')
    .text(formatCost(data.genConCost));
  ...
  $('#costEstimateOverview')
    .find('#refrigProposal')
    .text(convertProposalReq(data.refrigProposalReq));
  $('#costEstimateOverview')
    .find('#refrigSub')
    .text(convertSubName(data.refrigSubName));
  $('#costEstimateOverview')
    .find('#refrigCostO')
    .text(formatCost(data.refrigCost));
  ...
  $('#costEstimateOverview')
    .find('#mechanicalProposal')
    .text(convertProposalReq(data.mechanicalProposalReq));
  $('#costEstimateOverview')
    .find('#mechanicalSub')
    .text(convertSubName(data.mechanicalSubName));
  $('#costEstimateOverview')
    .find('#mechanicalCostO')
    .text(formatCost(data.mechanicalCost));
  $('#costEstimateOverview')
    .find('#mechanicalSubmit')
    .text(data.mechanicalSubmitDate);
  $('#costEstimateOverview')
    .find('#mechanicalScope')
    .text(data.mechanicalScope);
  $('#costEstimateOverview')
    .find('#mechanicalNotesO')
    .text(data.mechanicalNotes);

  $('#costEstimateOverview')
    .find('#electricalProposal')
    .text(convertProposalReq(data.electricalProposalReq));
  $('#costEstimateOverview')
    .find('#electricalSub')
    .text(convertSubName(data.electricalSubName));
  $('#costEstimateOverview')
    .find('#electricalCostO')
    .text(formatCost(data.electricalCost));
  $('#costEstimateOverview')
    .find('#electricalSubmit')
    .text(data.electricalSubmitDate);
  $('#costEstimateOverview')
    .find('#electricalScope')
    .text(data.electricalScope);
  $('#costEstimateOverview')
    .find('#electricalNotesO')
    .text(data.electricalNotes);

  $('#costEstimateOverview')
    .find('#plumbingProposal')
    .text(convertProposalReq(data.plumbingProposalReq));
  $('#costEstimateOverview')
    .find('#plumbingSub')
    .text(convertSubName(data.plumbingSubName));
  $('#costEstimateOverview')
    .find('#plumbingCostO')
    .text(formatCost(data.plumbingCost));
  $('#costEstimateOverview')
    .find('#plumbingSubmit')
    .text(data.plumbingSubmitDate);
  ...
  $('#costEstimateOverview')
    .find('#gasProposal')
    .text(convertProposalReq(data.gasProposalReq));
  $('#costEstimateOverview')
    .find('#gasSub')
    .text(convertSubName(data.gasSubName));
  ...
  $('#costEstimateOverview')
    .find('#sprinklerProposal')
    .text(convertProposalReq(data.sprinklerProposalReq));
  $('#costEstimateOverview')
    .find('#sprinklerSub')
    .text(convertSubName(data.sprinklerSubName));
  $('#costEstimateOverview')
    .find('#sprinklerCostO')
    .text(formatCost(data.sprinklerCost));
  $('#costEstimateOverview')
    .find('#sprinklerSubmit')
    .text(data.sprinklerSubmitDate);
  ...
  $('#costEstimateOverview')
    .find('#fireAlarmProposal')
    .text(convertProposalReq(data.fireAlarmProposalReq));
  $('#costEstimateOverview')
    .find('#fireAlarmSub')
    .text(convertSubName(data.fireAlarmSubName));
  $('#costEstimateOverview')
    .find('#fireAlarmCostO')
    .text(formatCost(data.fireAlarmCost));
  $('#costEstimateOverview')
    .find('#fireAlarmSubmit')
    .text(data.fireAlarmSubmitDate);
  ...
  $('#costEstimateOverview')
    .find('#carpenterProposal')
    .text(convertProposalReq(data.carpenterProposalReq));
  $('#costEstimateOverview')
    .find('#carpenterSub')
    .text(convertSubName(data.carpenterSubName));
  $('#costEstimateOverview')
    .find('#carpenterCostO')
    .text(formatCost(data.carpenterCost));
  $('#costEstimateOverview')
    .find('#carpenterSubmit')
    .text(data.carpenterSubmitDate);
  ...
  $('#costEstimateOverview')
    .find('#equipmentProposal')
    .text(convertProposalReq(data.equipmentProposalReq));
  $('#costEstimateOverview')
    .find('#equipmentSub')
    .text(convertSubName(data.equipmentSubName));
  $('#costEstimateOverview')
    .find('#equipmentCostO')
    .text(formatCost(data.equipmentCost));
  $('#costEstimateOverview')
    .find('#equipmentSubmit')
    .text(data.equipmentSubmitDate);
  ...
  $('#costEstimateOverview')
    .find('#supervisionProposal')
    .text(convertProposalReq(data.supervisionProposalReq));
  $('#costEstimateOverview')
    .find('#supervisionSub')
    .text(convertSubName(data.supervisionSubName));
  $('#costEstimateOverview')
    .find('#supervisionCostO')
    .text(formatCost(data.supervisionCost));
  $('#costEstimateOverview')
    .find('#supervisionSubmit')
    .text(data.supervisionSubmitDate);
  $('#costEstimateOverview')
    .find('#supervisionScope')
    .text(data.supervisionScope);
  $('#costEstimateOverview')
    .find('#supervisionNotesO')
    .text(data.supervisionNotes);

  $('#costEstimateOverview')
    .find('#profitProposal')
    .text(convertProposalReq(data.profitProposalReq));
  $('#costEstimateOverview')
    .find('#profitSub')
    .text(convertSubName(data.profitSubName));
  $('#costEstimateOverview')
    .find('#profitCostO')
    .text(formatCost(data.profitCost));
  ...
  $('#costEstimateOverview')
    .find('#taxesProposal')
    .text(convertProposalReq(data.taxesProposalReq));
  $('#costEstimateOverview')
    .find('#taxesSub')
    .text(convertSubName(data.taxesSubName));
  $('#costEstimateOverview')
    .find('#taxesCostO')
    .text(formatCost(data.taxesCost));
  ...
  $('#costEstimateOverview')
    .find('#totalProposal')
    .text(convertProposalReq(data.totalProposalReq));
  $('#costEstimateOverview')
    .find('#totalSub')
    .text(convertSubName(data.totalSubName));
  $('#costEstimateOverview')
    .find('#totalCostO')
    .text(formatCost(data.totalCost));
...
function setCostCompTitle() {
  ...
  if (
    PROJECT_DATA.warehouse.state &&
    (PROJECT_DATA.warehouse.state == 'UNKNOWN' ||
      PROJECT_DATA.warehouse.state == 'Unknown')
  ) {
    $('#smartProjectComparison')
      .find('#currentProj')
      .text(
        PROJECT_DATA.warehouse.city.name + ', ' + PROJECT_DATA.warehouse.region
      );
  } else {
    $('#smartProjectComparison')
      .find('#currentProj')
      .text(
        PROJECT_DATA.warehouse.city.name +
          ', ' +
          toTitleCase(PROJECT_DATA.warehouse.state.replace('_', ' '))
      );
  }
}
...
function fillCostComparison(data) {
  ...
  $('#smartProjectComparison')
    .find('#projGenConCost')
    .text(fixCost(data.genConCost));
  $('#smartProjectComparison')
    .find('#projRefrigCost')
    .text(fixCost(data.refrigCost));
  $('#smartProjectComparison')
    .find('#projMechanicalCost')
    .text(fixCost(data.mechanicalCost));
  $('#smartProjectComparison')
    .find('#projElectricalCost')
    .text(fixCost(data.electricalCost));
  $('#smartProjectComparison')
    .find('#projPlumbingCost')
    .text(fixCost(data.plumbingCost));
  $('#smartProjectComparison').find('#projGasCost').text(fixCost(data.gasCost));
  $('#smartProjectComparison')
    .find('#projSprinklerCost')
    .text(fixCost(data.sprinklerCost));
  $('#smartProjectComparison')
    .find('#projFireAlarmCost')
    .text(fixCost(data.fireAlarmCost));
  $('#smartProjectComparison')
    .find('#projTotalCost')
    .text(fixCost(data.totalCost));
}
...
function fillComp(cost, proj) {
  ...
  if (
    proj.warehouse.state &&
    (proj.warehouse.state == 'UNKNOWN' || proj.warehouse.state == 'Unknown')
  ) {
    op.innerHTML = proj.warehouse.city.name + ', ' + proj.warehouse.region;
  } else {
    op.innerHTML =
      proj.warehouse.city.name +
      ', ' +
      toTitleCase(proj.warehouse.state.replace('_', ' '));
  }
...
function fillColumn(data, col) {
  ...
  $('#smartProjectComparison')
    ...
    .text(fixCost(data.refrigCost));
  $('#smartProjectComparison')
    .find('#' + col + 'MechanicalCost')
    .text(fixCost(data.mechanicalCost));
  $('#smartProjectComparison')
    .find('#' + col + 'ElectricalCost')
    .text(fixCost(data.electricalCost));
  $('#smartProjectComparison')
    .find('#' + col + 'PlumbingCost')
    .text(fixCost(data.plumbingCost));
  $('#smartProjectComparison')
    .find('#' + col + 'GasCost')
    .text(fixCost(data.gasCost));
  $('#smartProjectComparison')
    .find('#' + col + 'SprinklerCost')
    .text(fixCost(data.sprinklerCost));
  $('#smartProjectComparison')
    .find('#' + col + 'FireAlarmCost')
    .text(fixCost(data.fireAlarmCost));
  $('#smartProjectComparison')
    .find('#' + col + 'TotalCost')
    .text(fixCost(data.totalCost));
...
function fillCostCompScope(data, masterScope) {
  ...
  if (data.quantity1 == '0')
    ...
    $('#smartProjectComparison')
      .find('#i1')
      .text(checkNull(data.item1) + ' (' + masterScope.quantity1 + ')');
  ...
  if (data.quantity2 == '0')
    ...
    $('#smartProjectComparison')
      .find('#i2')
      .text(checkNull(data.item2) + ' (' + masterScope.quantity2 + ')');
  ...
  if (data.quantity3 == '0')
    ...
    $('#smartProjectComparison')
      .find('#i3')
      .text(checkNull(data.item3) + ' (' + masterScope.quantity3 + ')');
  ...
  if (data.quantity4 == '0')
    ...
    $('#smartProjectComparison')
      .find('#i4')
      .text(checkNull(data.item4) + ' (' + masterScope.quantity4 + ')');
  ...
  if (data.quantity5 == '0')
    ...
    $('#smartProjectComparison')
      .find('#i5')
      .text(checkNull(data.item5) + ' (' + masterScope.quantity5 + ')');
  ...
  if (data.quantity6 == '0')
    ...
    $('#smartProjectComparison')
      .find('#i6')
      .text(checkNull(data.item6) + ' (' + masterScope.quantity6 + ')');
  ...
  if (data.quantity7 == '0')
    ...
    $('#smartProjectComparison')
      .find('#i7')
      .text(checkNull(data.item7) + ' (' + masterScope.quantity7 + ')');
  ...
  if (data.quantity8 == '0')
    ...
    $('#smartProjectComparison')
      .find('#i8')
      .text(checkNull(data.item8) + ' (' + masterScope.quantity8 + ')');
  ...
  if (data.quantity9 == '0')
    ...
    $('#smartProjectComparison')
      .find('#i9')
      .text(checkNull(data.item9) + ' (' + masterScope.quantity9 + ')');
  ...
  if (data.quantity10 == '0')
    ...
    $('#smartProjectComparison')
      .find('#i10')
      .text(checkNull(data.item10) + ' (' + masterScope.quantity10 + ')');
}
...
function saveProjSpecScope() {
  ...
  if (edit_PROJ_SCOPE == 'true') action = 'editProjSpecScope';
...
function fillProjSpecScopeTable(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    console.log(row[7]);
    if (row[7]) itemNum.appendChild(document.createTextNode(row[7]));
    else itemNum.appendChild(document.createTextNode('---'));

    var title = document.createElement('td');

    if (row[1]) title.appendChild(document.createTextNode(row[1]));
    else title.appendChild(document.createTextNode('---'));
    ...
    var notes = document.createElement('td');
    if (row[4]) notes.appendChild(document.createTextNode(row[4]));
    else notes.appendChild(document.createTextNode('---'));
...
function setProjSpecScopeTitle() {
  ...
  span.innerHTML =
    '' + PROJECT_DATA.projectItem.name + ' : Project Specific Scope';
}
...
function addCheckBoxes(data) {
  ...
  if (data.item1 != '') $('#projectMasterScope').find('#item1check').show();
  else $('#projectMasterScope').find('#item1check').hide();

  if (data.item2 != '') $('#projectMasterScope').find('#item2check').show();
  else $('#projectMasterScope').find('#item2check').hide();

  if (data.item3 != '') $('#projectMasterScope').find('#item3check').show();
  else $('#projectMasterScope').find('#item3check').hide();

  if (data.item4 != '') $('#projectMasterScope').find('#item4check').show();
  else $('#projectMasterScope').find('#item4check').hide();

  if (data.item5 != '') $('#projectMasterScope').find('#item5check').show();
  else $('#projectMasterScope').find('#item5check').hide();

  if (data.item6 != '') $('#projectMasterScope').find('#item6check').show();
  else $('#projectMasterScope').find('#item6check').hide();

  if (data.item7 != '') $('#projectMasterScope').find('#item7check').show();
  else $('#projectMasterScope').find('#item7check').hide();

  if (data.item8 != '') $('#projectMasterScope').find('#item8check').show();
  else $('#projectMasterScope').find('#item8check').hide();

  if (data.item9 != '') $('#projectMasterScope').find('#item9check').show();
  else $('#projectMasterScope').find('#item9check').hide();

  if (data.item10 != '') $('#projectMasterScope').find('#item10check').show();
  else $('#projectMasterScope').find('#item10check').hide();
}
...
function fillChecksAndDropdowns(data) {
  ...
  $('#projectMasterScope')
    .find('#item1check')
    .prop('checked', convertItems(data.item1));
  $('#projectMasterScope')
    .find('#item2check')
    .prop('checked', convertItems(data.item2));
  $('#projectMasterScope')
    .find('#item3check')
    .prop('checked', convertItems(data.item3));
  $('#projectMasterScope')
    .find('#item4check')
    .prop('checked', convertItems(data.item4));
  $('#projectMasterScope')
    .find('#item5check')
    .prop('checked', convertItems(data.item5));
  $('#projectMasterScope')
    .find('#item6check')
    .prop('checked', convertItems(data.item6));
  $('#projectMasterScope')
    .find('#item7check')
    .prop('checked', convertItems(data.item7));
  $('#projectMasterScope')
    .find('#item8check')
    .prop('checked', convertItems(data.item8));
  $('#projectMasterScope')
    .find('#item9check')
    .prop('checked', convertItems(data.item9));
  $('#projectMasterScope')
    .find('#item10check')
    .prop('checked', convertItems(data.item10));
...
function prepareScorecardUpdate(data) {
  ...
  for (var rule in data) {
    if (rule == 'PROJECT' || rule == 'applicableRules') continue;

    for (var i = 0; i < RULES.length; i++) {
      if (RULES[i].id == data[rule].RULE_ID) {
        if (data[rule].passed != undefined) RULES[i].passed = data[rule].passed;
        else if (
          data[rule].taskResults ||
          data[rule].equipmentResult ||
          data[rule].changeOrderResults
        ) {
          if (evaluateSetResults(data[rule]) == true) RULES[i].passed = 'true';
          else RULES[i].passed = 'false';
        }
      }
    }
  }
...
function prepareScorecardView(data) {
  ...
  for (var score in data) {
    if (score == 'PROJECT' || score == 'applicableRules') continue;
    ...
    for (var i = 0; i < SCORE.length; i++) {
      if (SCORE[i].id == data[score].RULE_ID) {
        if (data[score].passed != undefined)
          ...
          data[score].taskResults ||
          data[score].equipmentResult ||
          data[score].changeOrderResults
        ) {
          if (evaluateSetResults(data[score]) == true) SCORE[i].passed = 'true';
          else SCORE[i].passed = 'false';
        }
      }
    }
  }
...
function evaluateSetResults(data) {
  if (data.taskResults) {
    for (var task in data.taskResults) {
      ...
      if (data.taskResults[task].passed == 'false') return false;
    }
  }

  if (data.changeOrderResults) {
    for (var changeOrder in data.changeOrderResults) {
      if (changeOrder == 'CHANGE ORDER') continue;

      if (data.changeOrderResults[changeOrder].passed == 'false') return false;
    }
  }

  if (data.equipmentResults) {
    for (var equipment in data.equipmentResults) {
      if (equipment == 'CHANGE ORDER') continue;

      if (data.equipmentResults[equipment].passed == 'false') return false;
    }
  }
...
function displayScoresUpdate(domain) {
  ...
  var header = domain;
  if (domain == 'PermitsAndInspections') header = 'Permits and Inspections';
  if (domain == 'ChangeOrders') header = 'Change Orders';
  if (domain == 'GeneralInfo') header = 'General Information';
...
function fillScoreTableUpdate(domain) {
  ...
  for (var i = 0; i < RULES.length; i++) {
    ...
    if (RULES[i].passed == 'true') continue;
    ...
    if (RULES[i].severity == 'HIGH') $(tr).css('background-color', HIGH_COLOR);
    if (RULES[i].severity == 'LOW') $(tr).css('background-color', LOW_COLOR);
...
function fillScoreTableView(domain) {
  ...
  for (var i = 0; i < SCORE.length; i++) {
    if (SCORE[i].domain != domain) continue;
    if (SCORE[i].passed == 'true') continue;
    ...
    if (SCORE[i].severity == 'HIGH') $(tr).css('background-color', HIGH_COLOR);
    if (SCORE[i].severity == 'LOW') $(tr).css('background-color', LOW_COLOR);
...
function getWorstScoreUpdate(data, rules, domain) {
  ...
  for (var i = 0; i < rules.length; i++) {
    ...
    if (
      data[rules[i].title] &&
      (data[rules[i].title].passed == 'false' ||
        data[rules[i].title].passed == undefined)
    ) {
      if (worst == undefined) worst = rules[i].severity;
      else if (worst == 'LOW' && rules[i].severity == 'HIGH')
        worst = rules[i].severity;
      else if (worst == 'HIGH' && rules[i].severity == 'HIGH') return 'HIGH';
    }
  }
...
function getWorstScoreView(data, scores, domain) {
  ...
  for (var i = 0; i < scores.length; i++) {
    if (scores[i].domain != domain) continue;
    ...
    if (
      data[scores[i].title] &&
      (data[scores[i].title].passed == 'false' ||
        data[scores[i].title].passed == undefined)
    ) {
      if (worst == undefined) worst = scores[i].severity;
      else if (worst == 'LOW' && scores[i].severity == 'HIGH')
        worst = scores[i].severity;
      else if (worst == 'HIGH' && scores[i].severity == 'HIGH') return 'HIGH';
    }
  }
  ...
  for (var i = 0; i < rules.length; i++) {
    ...
    if (data[rules[i].title].changeOrderResults) {
      for (var changeOrder in data[rules[i].title].changeOrderResults) {
        if (
          data[rules[i].title].changeOrderResults[changeOrder].passed == 'false'
        ) {
          if (worst == undefined) worst = rules[i].severity;
          else if (worst == 'LOW' && rules[i].severity == 'HIGH')
            worst = rules[i].severity;
    ...
    if (data[rules[i].title].equipmentResults) {
      for (var equipment in data[rules[i].title].equipmentResults) {
        if (
          data[rules[i].title].equipmentResults[equipment].passed == 'false'
        ) {
          if (worst == undefined) worst = rules[i].severity;
          else if (worst == 'LOW' && rules[i].severity == 'HIGH')
            worst = rules[i].severity;
  ...
  for (var i = 0; i < scores.length; i++) {
    ...
    if (scores[i].changeOrderResults) {
      for (var changeOrder in data[scores[i].title].changeOrderResults) {
        if (
          data[scores[i].title].changeOrderResults[changeOrder].passed ==
          'false'
        ) {
          if (worst == undefined) worst = scores[i].severity;
          else if (worst == 'LOW' && scores[i].severity == 'HIGH')
    ...
    if (scores[i].equipmentResults) {
      for (var equipment in data[scores[i].title].equipmentResults) {
        if (
          data[scores[i].title].equipmentResults[equipment].passed == 'false'
        ) {
          if (worst == undefined) worst = scores[i].severity;
          else if (worst == 'LOW' && scores[i].severity == 'HIGH')
            worst = rules[i].severity;
...
function fillNavScopeDropdowns(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    a.setAttribute(
      'onmouseover',
      "style='background-color: rgb(42, 112, 224); color: white'"
    );
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (RETRIEVED_PROJECTS)
        console.log('getAllProjects() - PROJECTS HAVE BEEN RETRIEVED');
...
function updateDisplayableProjects() {
  if (!RETRIEVED_PROJECTS) {
    console.log('Should have projects by now!');
    return;
  }
  refreshProjects();
  ...
  for (var i = 0; i < RETRIEVED_PROJECTS.length; i++) {
    for (var q = 0; q < stagesOfInterest.length; q++) {
      if (stagesOfInterest[q].value == RETRIEVED_PROJECTS[i].stage.id) {
        ...
        if (
          typesOfInterestMatch(
            typesOfInterest,
            RETRIEVED_PROJECTS[i].projectType.id
          ) == true
        ) {
...
function typesOfInterestMatch(typesOfInterest, projectTypeId) {
  for (var q = 0; q < typesOfInterest.length; q++) {
    if (typesOfInterest[q].value == projectTypeId) return true;
  }
  return false;
}
...
function fillDropdowns_FIND_PROJECT(data) {
  ...
  warehouseOptions = generateDropdowns_FIND_PROJECTS(
    data['warehouse'],
    parameterFields[0]
  );
  classOptions = generateDropdowns_FIND_PROJECTS(
    data['class'],
    parameterFields[1]
  );
  itemOptions = generateDropdowns_FIND_PROJECTS(
    data['item'],
    parameterFields[2]
  );
  managerOptions = generateDropdowns_FIND_PROJECTS(
    data['person'],
    parameterFields[3]
  );
  supervisorOptions = generateDropdowns_FIND_PROJECTS(
    data['person'],
    parameterFields[4]
  );
  typeOptions = generateDropdowns_FIND_PROJECTS(
    data['type'],
    parameterFields[5]
  );
  statusOptions = generateDropdowns_FIND_PROJECTS(
    data['status'],
    parameterFields[6]
  );
    ...
    if (field == 'Warehouse') {
      ...
      if (sorted == false) {
        ...
        for (var q = 0; q < json.length; q++) {
          if (json[q].id == 8) {
            sortedStages[0] = json[q];
          } else if (json[q].id == 1) {
            sortedStages[1] = json[q];
          } else if (json[q].id == 2) {
            sortedStages[2] = json[q];
          } else if (json[q].id == 17) {
            sortedStages[3] = json[q];
          } else if (json[q].id == 16) {
            sortedStages[4] = json[q];
          } else if (json[q].id == 4) {
            sortedStages[6] = json[q];
          } else if (json[q].id == 9) {
            sortedStages[7] = json[q];
          } else if (json[q].id == 15) {
            sortedStages[8] = json[q];
          }
        }
...
function filterProjects(filter) {
  if (filter != undefined) console.log(filter);
    ...
    for (var i = 0; i < paramNum * 2; i += 2) {
      ...
      for (var j = 0; j < json.length; j++) {
        if (id === 'Warehouse') {
          ...
          if (
            json[j] != null &&
            json[j].supervisors != null &&
            json[j].supervisors[0].id != val
          ) {
            json[j] = null;
            remaining = remaining - 1;
          }
          ...
          if (json[j] != null && json[j].stage.id != val) {
            if (json[j] != null && json[j].McsNumber == 15257) {
              console.log('Filter: ', id, json[j]);
            }
            json[j] = null;
            remaining = remaining - 1;
          }
    ...
    if (remaining == 0) {
      ...
      for (var k = 0; k < json.length; k++) {
        if (json[k] != null) {
          ...
          if (
            json[k].warehouse &&
            json[k].warehouse.city &&
            json[k].warehouse.city.name &&
            json[k].warehouse.city.name.includes('APANA')
          ) {
            listDetails0.innerHTML =
              json[k].warehouse.city.name + ', ' + json[k].warehouse.region;
          } else {
            listDetails0.innerHTML =
              json[k].warehouse.city.name +
              ' #' +
          ...
          if (json[k].mediumScore == 0)
            listDetails3.setAttribute('class', 'circle_green');
          else if (json[k].mediumScore == 1)
            listDetails3.setAttribute('class', 'circle_yellow');
          else listDetails3.setAttribute('class', 'circle_red');
          if (
            json[k].stage.name == 'Active' ||
            json[k].stage.name == 'Closed' ||
            json[k].stage.name == 'Canceled' ||
            json[k].stage.name == 'On Hold'
          ) {
...
function fillProjectViewData(json) {
  ...
  if (
    ...
    json.warehouse.city &&
    json.warehouse.city.name &&
    json.warehouse.city.name.includes('APANA')
  ) {
    listDetails0.innerHTML =
      json.warehouse.city.name + ', ' + json.warehouse.region;
  } else {
    listDetails0.innerHTML =
      json.warehouse.city.name + ' #' + json.warehouse.warehouseID;
  }
  ...
  } else if (json.mediumScore == 0)
    listDetails3.setAttribute('class', 'circle_green');
  else if (json.mediumScore == 1)
    listDetails3.setAttribute('class', 'circle_yellow');
  else listDetails3.setAttribute('class', 'circle_red');
  if (
    json.stage.name == 'Active' ||
    json.stage.name == 'Closed' ||
    json.stage.name == 'Canceled' ||
    json.stage.name == 'On Hold'
  ) {
      ...
      success: function (data) {
        ...
        if (edit_CHANGE_ORDER == 'true') {
          ...
          if (PROJECT_DATA.changeOrders) {
            if (PROJECT_DATA.changeOrders.length != 0) {
              mcsCO = PROJECT_DATA.changeOrders.length + 1;
            } else mcsCO = 1;
          } else {
            mcsCO = 1;
          }
...
function fillTabs_CHANGE_ORDER(json) {
  ...
  if (PROJECT_DATA.changeOrders.length)
    nextCOnum = PROJECT_DATA.changeOrders.length;
  else nextCOnum = 1;
  ...
  if (changeOrderToEdit) {
    ...
    formatRelativeTextAreas(
      changeOrderToEdit.briefDescription,
      'briefDescription',
      'changeOrder'
    );
    $('#changeOrder')
      .find('#briefDescription')
      .val(changeOrderToEdit.briefDescription);
    $('#changeOrder').find('#subNames').val(changeOrderToEdit.subNames);

    if (changeOrderToEdit.cost)
      changeOrderToEdit.cost = cleanNumericValueForDisplaying(
        changeOrderToEdit.cost
      );
    $('#changeOrder').find('#cost').val(changeOrderToEdit.cost);

    if (changeOrderToEdit.sell)
      changeOrderToEdit.sell = cleanNumericValueForDisplaying(
        changeOrderToEdit.sell
      );
    ...
    $('#changeOrder')
      .find('#submittedDate')
      .val(changeOrderToEdit.submittedDate);
    ...
    $('#changeOrder')
      .find('#invoiceNumber')
      .val(changeOrderToEdit.invoiceNumber);
    $('#changeOrder')
      .find('#customerCOPnum')
      .val(changeOrderToEdit.customerCOPnum);

    $('#changeOrder')
      .find('#mcsInvoiceStatus')
      .val(changeOrderToEdit.mcsInvoiceStatus);
    $('#changeOrder')
      .find('#subInvoiceStatus')
      .val(changeOrderToEdit.subInvoiceStatus);

    $('#changeOrder')
      .find('#subInvoiceNumber')
      .val(changeOrderToEdit.subInvoiceNumber);
...
function saveProject_CHANGE_ORDER() {
  ...
  if (edit_CHANGE_ORDER == 'true') action = 'editChangeOrder';
...
$(document).ready(function () {
  $('.nav-tabs > li').click(function () {
    if (
      $(this).attr('id') !== 'saveProjectLink' &&
      $(this).attr('id') !== 'backToFailedRules' &&
      $(this).attr('id') !== 'backToFailedRulesPermits' &&
      $(this).attr('id') !== 'save-permits' &&
      $(this).attr('id') !== 'backToFailedRulesCloseOut' &&
      $(this).attr('id') !== 'save-closeout'
    ) {
      //Why wasn't this if condition written before?
      $('.info-tab').removeClass('active');
      $('#' + $(this).attr('data-tab')).addClass('active');
...
function fillDropdowns_EQUIP_PROP(json) {
  $('#equipmentFormProposals')
    .find('#supplierProposals')
    .find('option')
    .remove();
  ...
  $('#equipmentFormProposals')
    .find('#deliveryStatusEquipmentProposals')
    .find('option')
    .remove();
...
function fillTabs_EQUIP(json) {
  ...
  else $('#equipmentForm #supplier').val('default');
  ...
  if (equipmentToEdit.eqStatus)
    $('#equipmentForm #deliveryStatusEquipment').val(
      equipmentToEdit.eqStatus.id
    );
  else $('#equipmentForm #deliveryStatusEquipment').val('default');
...
function fillTabs_EQUIP_PROP(json) {
  ...
  $('#equipmentFormProposals #equipmentNameProposals').val(
    equipmentToEdit.equipmentName
  );

  if (equipmentToEdit.eqSupplier)
    $('#equipmentFormProposals #supplierProposals').val(
      equipmentToEdit.eqSupplier.id
    );
  else $('#equipmentFormProposals #supplierProposals').val('default');

  $('#equipmentFormProposals #estDeliveryDateProposals').val(
    equipmentToEdit.estDeliveryDate
  );
  $('#equipmentFormProposals #deliveryDateProposals').val(
    equipmentToEdit.deliveryDate
  );
  $('#equipmentFormProposals #orderedDateProposals').val(
    equipmentToEdit.orderedDate
  );
  $('#equipmentFormProposals #equipProposalDateProposals').val(
    equipmentToEdit.equipProposalDate
  );
  $('#equipmentFormProposals #notesProposals').val(equipmentToEdit.notes);

  if (equipmentToEdit.eqStatus)
    $('#equipmentFormProposals #deliveryStatusEquipmentProposals').val(
      equipmentToEdit.eqStatus.id
    );
  else
    $('#equipmentFormProposals #deliveryStatusEquipmentProposals').val(
  ...
  $('#equipmentFormProposals #providerNameProposals').val(
    equipmentToEdit.providerName
  );
  $('#equipmentFormProposals #equipmentDescriptionProposals').val(
    equipmentToEdit.description
  );
  $('#equipmentFormProposals #unitPriceProposals').val(
    equipmentToEdit.unitPrice
  );
  $('#equipmentFormProposals #quantityProposals').val(equipmentToEdit.quantity);
  $('#equipmentFormProposals #totalPriceProposals').val(
    equipmentToEdit.totalPrice
  );
}
...
function saveProject_EQUIP() {
  ...
  if (PAGETYPE_EQUIP == 'edit') action = 'editEquipment';
...
function saveProject_EQUIP_PROP() {
  ...
  var equipmentName = $(
    '#equipmentFormProposals #equipmentNameProposals'
  ).val();

  var equipmentDescription = $(
    '#equipmentFormProposals #equipmentDescriptionProposals'
  ).val();
  ...
  var estDeliveryDate = $(
    '#equipmentFormProposals #estDeliveryDateProposals'
  ).val();
  var orderedDate = $('#equipmentFormProposals #orderedDateProposals').val();
  var equipProposalDate = $(
    '#equipmentFormProposals #equipProposalDateProposals'
  ).val();
  var notes = $('#equipmentFormProposals #notesProposals').val();
  var deliveryStatus = $(
    '#equipmentFormProposals #deliveryStatusEquipmentProposals'
  ).val();
...
function deleteEquipment() {
  ...
  if (
    !confirm(
      'Are you sure you want to permanently delete this piece of equipment?'
    )
  )
    return;
...
function toggleTaskAssignee() {
  if (taskAssigneeType == TASK_EMPLOYEE_ASSIGNEE) {
    ...
    $('#taskCreationZone').find('#employeeAssigneeTableElement').hide();
    $('#taskCreationZone').find('#subcontractorAssigneeTableElement').show();
    document.getElementById('toggleTaskAssignee').innerHTML =
      'Assign to Employee';
    ...
    document.getElementById('toggleTaskAssignee').value =
      TASK_EMPLOYEE_ASSIGNEE;
  }
}
...
function goToFindProject() {
  ...
  switch (currentDivLocation) {
    ...
    case 'projectManager':
      ...
      $('#projectManager').find('#projectInformation').addClass('active');
      $('#projectManager')
        .find('#projectInformationTabLink')
        .addClass('active');
      break;
    case 'changeOrder':
...
function convertCurrentDivLocation(currentDivLocation) {
  ...
  switch (currentDivLocation) {
    case 'projectManager':
      $('#' + currentDivLocation)
        .find('#pageLocation')
        .html("<p>Project Manager <small id='projectHeader'>---</small></p>");
      break;
    case 'projectData':
      $('#' + currentDivLocation)
        .find('#pageLocation')
        .html("<p>Project Editor <small id='projectHeader'>---</small></p>");
      break;
    case 'permitData':
      $('#' + currentDivLocation)
        .find('#pageLocation')
        .html(
          "<p>Permit & Inspection Editor <small id='projectHeader'>---</small></p>"
        );
      break;
    case 'costEstimateData':
      $('#' + currentDivLocation)
        .find('#pageLocation')
        .html(
          "<p>Cost Estimate Editor <small id='projectHeader'>---</small></p>"
        );
      break;
    case 'closeoutData':
      $('#' + currentDivLocation)
        .find('#pageLocation')
        .html("<p>Closeout Editor <small id='projectHeader'>---</small></p>");
      break;
    case 'scorecardUpperDiv':
      $('#' + currentDivLocation)
        .find('#pageLocation')
        .html("<p>Scorecard <small id='projectHeader'>---</small></p>");
      break;
    case 'failedRulesDiv':
      $('#' + currentDivLocation)
        .find('#pageLocation')
    ...
    case 'changeOrder':
      $('#' + currentDivLocation)
        .find('#pageLocation')
        .html("<p>Pricing Element <small id='projectHeader'>---</small></p>");
      break;
    case 'equipmentDiv':
      $('#' + currentDivLocation)
        .find('#pageLocation')
        .html("<p>Equipment <small id='projectHeader'>---</small></p>");
      break;
    case 'projectMasterScope':
      $('#' + currentDivLocation)
        .find('#masterScopeProjectTitle')
        .html("<p><small id='projectHeader'>---</small></p>");
  }
}
  ...
  if (project_id != null) {
    $.ajax({
      ...
      success: function (data) {
        ...
        let tableGeneral = document
          .getElementById('generalInfoFailedTable')
          .getElementsByTagName('tbody')[0];
        let tableScheduling = document
          .getElementById('schedulingFailedTable')
          .getElementsByTagName('tbody')[0];
        let tableEquipment = document
          .getElementById('equipmentFailedTable')
          .getElementsByTagName('tbody')[0];
        let tableChangeOrders = document
          .getElementById('changeOrdersFailedTable')
          .getElementsByTagName('tbody')[0];
        let tableTasks = document
          .getElementById('tasksFailedTable')
          .getElementsByTagName('tbody')[0];
        let tableFinancial = document
          .getElementById('financialFailedTable')
          .getElementsByTagName('tbody')[0];
        let tablePermits = document
          .getElementById('permitsFailedTable')
          .getElementsByTagName('tbody')[0];
        let tableCloseOut = document
          .getElementById('closeOutFailedTable')
          .getElementsByTagName('tbody')[0];
        ...
        for (var i = 0; i < data.length; i++) {
          if (data[i].ruleCategory == 'GeneralInfo') {
            ...
            if (data[i].severity == 0) {
              ...
              if (scoreGeneral[0] != 'Red') scoreGeneral = ['#FFD800', 'LOW'];
            } else {
            ...
            var text2 = document.createTextNode(
              data[i].failMessage.split('~')[0]
            );
            var text3 = document.createTextNode(
              data[i].failMessage.split('~')[1]
            );
            td1.appendChild(text1);
            td2.appendChild(text2);
            ...
            if (data[i].severity == 0) {
              td1.style.background = '#FFD800';
              if (scoreTasks[0] != 'Red') scoreTasks = ['#FFD800', 'LOW'];
            } else {
              td1.style.background = 'Red';
              scoreTasks = ['Red', 'HIGH'];
            }
            ...
            if (data[i].severity == 0) {
              td1.style.background = '#FFD800';
              if (scorePermits[0] != 'Red') scorePermits = ['#FFD800', 'LOW'];
            } else {
              td1.style.background = 'Red';
            ...
            if (data[i].severity == 0) {
              td1.style.background = '#FFD800';
              if (scoreCloseOut[0] != 'Red') scoreCloseOut = ['#FFD800', 'LOW'];
            } else {
              td1.style.background = 'Red';
...
function getFailedRules(table_id) {
  //A.R.G
  if ($('#' + table_id + '> tbody > tr').length > 0) {
    //condition where if issues are 0, then user click will not work
...
function hidingTables(table_id) {
  $('#failedRulesTable table').filter(function () {
    if (this.id != table_id) {
      $(this).hide();
    } else $(this).show();
  });
...
function emptyingTables() {
  $('#failedRulesTable table > tbody').filter(function () {
    $(this).empty();
  });
}

function returnToScoreCardView() {
  //A.R.G
  $('#findProject').hide();
  $('#scoreCardTopDiv').show();
  $('#scoreCardFailedRulesDiv').hide();
...
function scoreBackground(
  ...
  document.getElementById('generalInfoScore').style.background =
    scoreGeneral[0];
  document.getElementById('schedulingScore').style.background =
    scoreScheduling[0];
  document.getElementById('permitsAndInspectionsScore').style.background =
    scorePermits[0];
  document.getElementById('equipmentScore').style.background =
    scoreEquipment[0];
  document.getElementById('changeOrdersScore').style.background =
    scoreChangeOrders[0];
  ...
  document.getElementById('financialScore').style.background =
    scoreFinancial[0];
  ...
  document.getElementById('permitsAndInspectionsScore').innerHTML =
    scorePermits[1];
...
function scrollSmoothToBottom(id) {
  //For Change Orders to go to the bottom
...
function submitTask() {
  ...
  if (typeof projectID === 'undefined')
    return alert('Project ID Failed. Find Another Project');
...
function submitPendInv() {
  let invoiceNum = $('#pendingInvoiceCreationZone')
    .find('#invoiceNumberPend')
    .val();
  let invoiceAmt = $('#pendingInvoiceCreationZone')
    .find('#invoiceAmtPend')
    .val();
  let subNames = $('#pendingInvoiceCreationZone').find('#subNamesPend').val();
  let submittedDate = $('#pendingInvoiceCreationZone')
    .find('#submittedDatePend')
    .val();
  let description = $('#pendingInvoiceCreationZone')
    .find('#briefDescriptionPend')
    .val();
  ...
  if (typeof projectID === 'undefined')
    return alert('Project ID Failed. Find Another Project');
  if (typeof invoiceNum === 'undefined' || invoiceNum === '')
    return alert('Invoice Number is Mandatory');
  if (typeof invoiceAmt === 'undefined' || invoiceAmt === '')
    return alert('Invoice Amount is Mandatory');
  if (typeof subNames === 'undefined' || subNames === '')
    return alert('Sub Name is Mandatory');
  if (typeof submittedDate === 'undefined' || submittedDate === '')
    return alert('Submitted Date is Mandatory');
  if (typeof description === 'undefined' || description === '')
    return alert('Description is Mandatory');
  if (typeof pendStatus === 'undefined' || pendStatus === '')
    return alert('Status is Mandatory');
    ...
    $.ajax({
      ...
      complete: function (serverResponse) {
        ...
        if (response === 'PENDINV_ADDED') {
          ...
          document.getElementById('pendingInvoiceInformation').style.width =
            '100%';
          $('#pendingInvoiceCreationZone').hide();
          $('#pendingInvoiceDisplay').show();
          clearPendingInvoiceTable();
  ...
  $.ajax({
    ...
    complete: function (data) {
      if (data.responseJSON) {
        ...
        console.log('NO RESPONSE JSON FROM getSubcontractors()');
      }
    },
  });
}
...
function fillPendInvsTable(pendInvs) {
  ...
  for (var i = 0; i < pendInvs.length; i++) {
    if (
      (selector === 'open' && pendInvs[i].status != 'Open') ||
    ...
    if (pendInvs[i].invoiceAmount)
      invoiceAmt.innerHTML = cleanNumericValueForDisplaying(
        pendInvs[i].invoiceAmount
      );
    else invoiceAmt.innerHTML = '---';
...
function createPendInv() {
  ...
  $('#pendingInvoiceInformation')
    .find('#pendingInvoiceCreationZone')
    .find('#pendingInvoiceStatusSelectionRow')
    .show();
  //adding the below line because when a new task is added, it is fetching the previous value.
  $('#pendingInvoiceInformation')
    .find('#pendingInvoiceCreationZone')
...
function fillPendInvWell(source) {
  ...
  $('#pendingInvoiceCreationZone')
    .find('#invoiceNumberPend')
    .val(selected_pendInv.invoiceNumber);
  $('#pendingInvoiceCreationZone')
    .find('#invoiceAmtPend')
    .val(selected_pendInv.invoiceAmount);
  $('#pendingInvoiceCreationZone')
    .find('#subNamesPend')
    .val(selected_pendInv.subNames);
  $('#pendingInvoiceCreationZone')
    .find('#submittedDatePend')
    .val(selected_pendInv.submittedDate);
  $('#pendingInvoiceCreationZone')
    .find('#briefDescriptionPend')
    .val(selected_pendInv.briefDescription);
  $('#pendingInvoiceCreationZone')
    .find('#statusPend')
    .val(selected_pendInv.status);
  $('#pendingInvoiceCreationZone')
    .find('#dbCoNumPend')
    .val(selected_pendInv.dbCONum);
  $('#pendingInvoiceCreationZone')
    .find('#poNumPend')
    .val(selected_pendInv.poNum);
  $('#pendingInvoiceCreationZone')
    .find('#notesPend')
    .val(selected_pendInv.notes);
}
...
function clearPendingInvoiceTable() {
  $('#pendingInvoiceDisplay')
    .find('#pendingInvoiceTable')
    .find('tr:not(.head)')
    .remove();
}
...
function changeStatus() {
  ...
  if (projectStage == '2') {
    ...
    $('#status ').append(
      $('<option>', { value: 4, text: 'Awaiting Direction' })
    );
    $('#status ').append(
      $('<option>', { value: 11, text: 'Awaiting Drawing' })
    );
    $('#status ').append($('<option>', { value: 30, text: 'Awaiting Permit' }));
    $('#status ').append(
      $('<option>', { value: 12, text: 'Awaiting Equipment' })
    );
    ...
    $('#status ').append(
      $('<option>', { value: 38, text: 'Budgetary - Preparing' })
    );
    $('#status ').append(
      $('<option>', { value: 37, text: 'Budgetary - Submitted' })
    );
  } else if (projectStage == '15') {
    //Canceled)
    $('#status ').append(
      $('<option>', { value: 4, text: 'Awaiting Direction' })
    );
    ...
    $('#status ').append($('<option>', { value: 35, text: 'Closeout' }));
    $('#status ').append(
      $('<option>', { value: 1, text: 'Proposal - Preparing' })
    );
    $('#status ').append(
      $('<option>', { value: 3, text: 'Proposal - Submitted' })
    );
    $('#status ').append($('<option>', { value: 29, text: 'Scheduled' }));
    $('#status ').append($('<option>', { value: 26, text: 'Scheduling' }));
  } else if (projectStage == '1') {
    //Proposal)
    $('#status ').append(
      $('<option>', { value: 4, text: 'Awaiting Direction' })
    );
...
function fillPeInvsTable(data) {
  ...
  for (var i = 0; i < changeOrders.length; i++) {
    ...
    if (
      $('#peInvoiceSelector2').val() == 'preparing' &&
      changeOrders[i].status != '1'
    )
      continue;
    else if (
      $('#peInvoiceSelector2').val() == 'submitted' &&
      changeOrders[i].status != '2'
    )
      continue;
    else if (
      $('#peInvoiceSelector2').val() == 'approved' &&
      changeOrders[i].status != '3'
    )
      continue;
    else if (
      $('#peInvoiceSelector2').val() == 'rejected' &&
      changeOrders[i].status != '4'
    )
      continue;
    else if (
      $('#peInvoiceSelector2').val() == 'complete' &&
      changeOrders[i].status != '5'
    )
      continue;
    else if (
      $('#peInvoiceSelector2').val() == 'review' &&
      changeOrders[i].status != '6'
    )
      continue;
    ...
    peType.width = '10%';
    peType.appendChild(
      document.createTextNode(parsePETypeStatus(changeOrder.peType))
    );
    ...
    for (var j = 0; j < invs.length; j++) {
      if (
        changeOrder.mcsCO == invs[j].associatedPE &&
        invs[j].invoiceStatus != 'Rejected' &&
        invs[j].invoiceStatus != 'Requested'
      ) {
        invoiced = invoiced + Number(invs[j].invoiceAmount);
      }
    }

    amountInvoiced.appendChild(
      document.createTextNode(cleanNumericValueForDisplaying(invoiced))
    );
    ...
    if (changeOrder.sell) {
      amountToInvoice.appendChild(
        document.createTextNode(
          cleanNumericValueForDisplaying(changeOrder.sell - invoiced)
        )
      );
    } else {
    ...
    invoicesPending.appendChild(
      document.createTextNode(
        cleanNumericValueForDisplaying(pendingInvoices.toFixed(2))
      )
    );
    ...
    if (
      changeOrder.type != 8 &&
      (changeOrder.status == '5' || changeOrder.status == '3')
    ) {
    ...
    tableRow.ondblclick = function () {
      ...
      if (
        changeOrder.type != 8 &&
        changeOrder.type != 7 &&
        parseChangeOrderStatus(changeOrder.status) != 'Rejected'
      ) {
...
function hideExtraInvoiceValues() {
  $('#invoiceInformation')
    .find('#invoiceCreationZone')
    .find('#invoiceStatusSelectionRow')
    .show();
...
function dataReadOnly() {
  alert(
    'Data is read only and summarizes the financial information in the project'
  );
}
...
function showAmountBox1() {
  ...
  if (
    $('#peInvoiceInformation')
      .find('#percentOrAmountRow1')
      .find('#percentOrAmount1')
      .val() == '2'
  ) {
    var invoiced = Number(0);
    ...
    for (var j = 0; j < invs.length; j++) {
      if (
        SELECTED_PE_ID.mcsCO == invs[j].associatedPE &&
        invs[j].invoiceStatus != 'Rejected'
      ) {
        invoiced = invoiced + Number(invs[j].invoiceAmount);
      }
    ...
    $('#peInvoiceInformation')
      .find('#invoiceAmount1')
      .val(cleanNumericValueForDisplaying(invoiceAmount));
  } else if (
    $('#peInvoiceInformation')
      .find('#percentOrAmountRow1')
      .find('#percentOrAmount1')
...
function showAmountBox() {
  ...
  if (
    $('#invoiceInformation')
      .find('#percentOrAmountRow')
      .find('#percentOrAmount')
      .val() == '2'
  ) {
    var invoiced = Number(0);
    var invoiceAmount = Number(0);
    ...
    $('#invoiceInformation')
      .find('#invoiceAmount')
      .val(cleanNumericValueForDisplaying(invoiceAmount.toFixed(2)));
  } else if (
    $('#invoiceInformation')
      .find('#percentOrAmountRow')
      .find('#percentOrAmount')
...
function populateInvoiceAmt(percentValue) {
  ...
  $('#invoiceInformation')
    .find('#invoiceAmount')
    .val(cleanNumericValueForDisplaying(invoicedAmount));
}
...
function populateInvoiceAmt1(percentValue1) {
  ...
  $('#peInvoiceInformation')
    .find('#invoiceAmount1')
    .val(cleanNumericValueForDisplaying(invoicedAmount1));
}
...
function createInv1() {
  ...
  $('#peInvoiceInformation')
    .find('#invoiceCreationZone1')
    .find('#invoiceID1')
    .val(invs.length + 1);
  $('#peInvoiceInformation')
    .find('#invoiceCreationZone1')
    .find('#invoiceStatusSelectionRow1')
    .find('#invoiceStatus1')
    .val('Requested');
  $('#peInvoiceInformation')
    .find('#invoiceCreationZone1')
    .find('#associatedPE1')
    .val(SELECTED_PE_ID.mcsCO);
  $('#peInvoiceInformation')
    .find('#invoiceCreationZone1')
    .find('#invoiceType1')
    .val(parsePETypeStatus(SELECTED_PE_ID.peType));
  $('#peInvoiceInformation')
    .find('#invoiceCreationZone1')
    .find('#invoiceCustomer1')
    .val(convertChangeOrderType(SELECTED_PE_ID.type));
  $('#peInvoiceInformation')
    .find('#invoiceCreationZone1')
    .find('#submittedDateInv1')
    .val(today);

  $('#peInvoiceInformation')
    .find('#invoiceCreationZone1')
    .find('#peInvNum1')
    .val(SELECTED_PE_ID.mcsCO + '-' + newInvMax);
...
function createInv() {
  ...
  $('#invoiceInformation')
    .find('#invoiceCreationZone')
    .find('#invTotal')
    .val(cleanNumericValueForDisplaying(SELECTED_PE_ID.sell));
  $('#invoiceInformation')
    .find('#invoiceCreationZone')
    .find('#invoiceBalance')
...
function fillInvWell(source) {
  ...
  $('#invoiceCreationZone')
    .find('#associatedPE')
    .val(selected_Inv.associatedPE);
  $('#invoiceCreationZone')
    .find('#invoiceNumber')
    .val(selected_Inv.invoiceNumber);
  $('#invoiceCreationZone')
    .find('#invoiceTitle')
    .val(selected_Inv.invoiceTitle);
  $('#invoiceCreationZone').find('#invoiceType').val(selected_Inv.invoiceType);
  $('#invoiceCreationZone')
    .find('#submittedDateInv')
    .val(selected_Inv.submittedDate);
  $('#invoiceCreationZone')
    .find('#invoiceCustomer')
    .val(selected_Inv.invoiceCustomer);
  $('#invoiceCreationZone')
    .find('#invoiceStatus')
    .val(selected_Inv.invoiceStatus);
  $('#invoiceCreationZone')
    .find('#invoiceApproval')
    .val(selected_Inv.invoiceApproval);
  $('#invoiceCreationZone')
    .find('#submitRejectDate')
    .val(selected_Inv.submitRejectDate);
  ...
  $('#invoiceCreationZone')
    .find('#invoiceAmount')
    .val(cleanNumericValueForDisplaying(selected_Inv.invoiceAmount));
  $('#invoiceInformation')
    .find('#invoiceCreationZone')
    .find('#invTotal')
    .val(cleanNumericValueForDisplaying(SELECTED_PE_ID.sell));
...
function fillInvsTable(data) {
  ...
  $('#invoiceInformation')
    .find('#totalPending1')
    .val(cleanNumericValueForDisplaying(pendingInvoiced.toFixed(2)));
  ...
  for (var i = 0; i < invs.length; i++) {
    ...
    else submitRejectDate.innerHTML = 'TBD';
...
function submitInv() {
  ...
  let submitRejectDate = $('#invoiceCreationZone')
    .find('#submitRejectDate')
    .val();
  let invoiceAmount = $('#invoiceCreationZone').find('#invoiceAmount').val();
  let invoiceCustomer = $('#invoiceCreationZone')
    .find('#invoiceCustomer')
    .val();
  ...
  if (INV_ACTION == 'createInv') {
    ...
    if (
      ...
      var allowedInvoicePercent =
        (allowedInvoiceAmount / Number(SELECTED_PE_ID.sell)) * 100;

      alert(
        'Invoice amount is invalid, please enter an amount less than or equal to: $' +
          allowedInvoiceAmount.toFixed(2) +
          ' or enter a percent less than or equal to: ' +
          allowedInvoicePercent.toFixed(2) +
          '%'
      );
      return;
    }
    ...
    alert(
      'Are you sure you want to add the invoice of amount ' +
        formatter.format(invoiceAmount) +
        '?'
    );
    $.ajax({
      type: 'POST',
...
function submitInv1() {
  ...
  let submittedDate = $('#invoiceCreationZone1')
    .find('#submittedDateInv1')
    .val();
  let invoiceAmount = $('#invoiceCreationZone1').find('#invoiceAmount1').val();

  let invoiceCustomer = $('#invoiceCreationZone1')
    .find('#invoiceCustomer1')
    .val();
  let invoiceStatus = $('#invoiceCreationZone1').find('#invoiceStatus1').val();

  let invoiceApproval = $('#invoiceCreationZone1')
    .find('#invoiceApproval1')
    .val();
  let notes = $('#invoiceCreationZone1').find('#notes1').val();

  let peInvNum = $('#peInvoiceInformation')
    .find('#invoiceCreationZone1')
    .find('#peInvNum1')
    .val();

  let approval1 = $('#peInvoiceInformation')
    .find('#invoiceCreationZone1')
    .find('#approval11')
    .val();
  let approval2 = $('#peInvoiceInformation')
    .find('#invoiceCreationZone1')
    .find('#approval21')
    .val();
  let approval3 = $('#peInvoiceInformation')
    .find('#invoiceCreationZone1')
    .find('#approval31')
    .val();
