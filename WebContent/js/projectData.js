...
function addProject()
{
    ...
    var MCSWarrantyDate = $("#MCSWarrantyDate").val();
    ...
    var equipmentSubmittalDate = $("#equipmentSubmittalDate").val();
    ...
    var closeOutPhotosDate = $("#closeOutPhotosDate").val();
    ...
    var alarmFormDate = $("#alarmFormDate").val();
